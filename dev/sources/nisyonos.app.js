...
const STATIONS = [
  {
    ...
    complaint: [
      ...
      { label: "עֲלִיָּה", he: "מְלַמֵּד שֶׁהָיוּ יִשְׂרָאֵל מַמְרִים בְּאוֹתָהּ שָׁעָה, וְאוֹמְרִים: כְּשֵׁם שֶׁאָנוּ עוֹלִים מִצַּד זֶה כָּךְ מִצְרַיִם עוֹלִים מִצַּד אַחֵר", ref: "ערכין טו. (על תהלים קו, ז)", url: "https://www.sefaria.org/Arakhin.15a" },
    ],
    hashem: [
  ...
  },
  {
    ...
    outcome: [
      { he: "וַיּוֹרֵהוּ ה' עֵץ וַיַּשְׁלֵךְ אֶל־הַמַּיִם וַיִּמְתְּקוּ הַמָּיִם — וְשָׁם נִסָּהוּ", ref: "שמות טו, כה", url: "https://www.sefaria.org/Exodus.15.25" },
    ],
    deaths: null,
  },
  {
  ...
  },
  {
    ...
    outcome: [
      { he: "וַיִּנָּחֶם ה' עַל־הָרָעָה אֲשֶׁר דִּבֶּר לַעֲשׂוֹת לְעַמּוֹ", ref: "שמות לב, יד", url: "https://www.sefaria.org/Exodus.32.14" },
    ],
    punishment: [
  ...
  },
  {
    ...
    interjection: [
      { he: "וַיִּצְעַק הָעָם אֶל־מֹשֶׁה וַיִּתְפַּלֵּל מֹשֶׁה אֶל־ה'", ref: "במדבר יא, ב", url: "https://www.sefaria.org/Numbers.11.2" },
    ],
    outcome: [
      { he: "וַתִּשְׁקַע הָאֵשׁ", ref: "במדבר יא, ב", url: "https://www.sefaria.org/Numbers.11.2" },
    ],
    punishment: [
  ...
  },
  {
    ...
    outcome: [
      { he: "אֶסְפָה־לִּי שִׁבְעִים אִישׁ מִזִּקְנֵי יִשְׂרָאֵל... וְנָשְׂאוּ אִתְּךָ בְּמַשָּׂא הָעָם וְלֹא־תִשָּׂא אַתָּה לְבַדֶּךָ", ref: "במדבר יא, טז–יז", url: "https://www.sefaria.org/Numbers.11.16" },
    ],
    punishment: [
  ...
  },
  {
    ...
    outcome: [
      { he: "וַיֹּאמֶר ה' סָלַחְתִּי כִּדְבָרֶךָ", ref: "במדבר יד, כ", url: "https://www.sefaria.org/Numbers.14.20" },
    ],
    punishment: [
  ...
  /* ---- beyond the ten: after the gzar din ---- */
  {
    ...
    outcome: [
      { he: "דַּבֵּר אֶל־הָעֵדָה לֵאמֹר הֵעָלוּ מִסָּבִיב לְמִשְׁכַּן־קֹרַח דָּתָן וַאֲבִירָם", ref: "במדבר טז, כד", url: "https://www.sefaria.org/Numbers.16.24" },
    ],
    punishment: [
  ...
  },
  {
    ...
    outcome: [
      { he: "עֲשֵׂה לְךָ שָׂרָף וְשִׂים אֹתוֹ עַל־נֵס וְהָיָה כָּל־הַנָּשׁוּךְ וְרָאָה אֹתוֹ וָחָי", ref: "במדבר כא, ח", url: "https://www.sefaria.org/Numbers.21.8" },
    ],
    punishment: [
        ...
        <tbody>
          {STATIONS.map((s, i) => (
            <tr key={s.id} className={s.within ? "" : "row-beyond"}>
              ...
              <td className="qcol"><TCell items={s.outcome} /></td>
