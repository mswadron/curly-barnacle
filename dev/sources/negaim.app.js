const { useState, useCallback, useRef, useMemo, useEffect, createContext, useContext } = React;
...
"יג:נב":{h:"וְשָׂרַף אֶת־הַבֶּגֶד אוֹ אֶת־הַשְּׁתִי אוֹ אֶת־הָעֵרֶב בַּצֶּמֶר אוֹ בַפִּשְׁתִּים אוֹ אֶת־כָּל־כְּלִי הָעוֹר אֲשֶׁר־יִהְיֶה בוֹ הַנָּגַע כִּי־צָרַעַת מַמְאֶרֶת הִוא בָּאֵשׁ תִּשָּׂרֵף.",e:"He shall burn the garment — warp or woof, in wool or in linen, or any leather article bearing the nega — for it is a mameres tzara'as; in fire it shall be burned."},
"יד:ב-ז":{h:"זֹאת תִּהְיֶה תּוֹרַת הַמְּצֹרָע בְּיוֹם טָהֳרָתוֹ וְהוּבָא אֶל־הַכֹּהֵן... וְלָקַח לַמִּטַּהֵר שְׁתֵּי־צִפֳּרִים חַיּוֹת טְהֹרוֹת וְעֵץ אֶרֶז וּשְׁנִי תוֹלַעַת וְאֵזֹב... וְהִזָּה עַל הַמִּטַּהֵר מִן־הַצָּרַעַת שֶׁבַע פְּעָמִים וְטִהֲרוֹ וְשִׁלַּח אֶת־הַצִּפֹּר הַחַיָּה עַל־פְּנֵי הַשָּׂדֶה.",e:"This shall be the law of the metzora on the day of his taharah: he is brought to the Kohen... two live tahor birds, cedar wood, scarlet thread, and hyssop... he sprinkles seven times on the one becoming tahor, declares him tahor, and sends the live bird out over the open field.",rh:"צפרים — לפי שהנגעים באים על לשון הרע, שהוא מעשה פטפוטי דברים, לפיכך הוזקקו צפרים שמפטפטין תמיד. עץ ארז — לפי שהנגעים באים על גסות הרוח. ושני תולעת ואזוב — ישפיל עצמו כתולעת וכאזוב.",re:"Birds — negaim come from lashon hara, an act of chatter; so chattering birds. Cedar — negaim come from haughtiness. Scarlet-worm and hyssop — let him lower himself like a worm and like hyssop."},
"יד:ח-ט":{h:"וְכִבֶּס הַמִּטַּהֵר אֶת־בְּגָדָיו וְגִלַּח אֶת־כָּל־שְׂעָרוֹ וְרָחַץ בַּמַּיִם וְטָהֵר... וְהָיָה בַיּוֹם הַשְּׁבִיעִי יְגַלַּח אֶת־כָּל־שְׂעָרוֹ אֶת־רֹאשׁוֹ וְאֶת־זְקָנוֹ וְאֵת גַּבֹּת עֵינָיו וְאֶת־כָּל־שְׂעָרוֹ יְגַלֵּחַ.",e:"He washes his clothes, shaves all his hair, immerses in water, and becomes tahor... and on the seventh day he shaves all his hair — his head, his beard, his eyebrows — all his hair he shaves."},
"יד:י-כ":{h:"וּבַיּוֹם הַשְּׁמִינִי יִקַּח שְׁנֵי־כְבָשִׂים תְּמִימִם וְכַבְשָׂה אַחַת בַּת־שְׁנָתָהּ תְּמִימָה וּשְׁלֹשָׁה עֶשְׂרֹנִים סֹלֶת מִנְחָה בְּלוּלָה בַשֶּׁמֶן וְלֹג אֶחָד שָׁמֶן.",e:"On the eighth day he takes two unblemished lambs, one unblemished ewe in its first year, three esronim of fine flour mixed with oil as a minchah, and one log of oil."},
"יד:לג-נג":{h:"כִּי תָבֹאוּ אֶל־אֶרֶץ כְּנַעַן אֲשֶׁר אֲנִי נֹתֵן לָכֶם לַאֲחֻזָּה וְנָתַתִּי נֶגַע צָרַעַת בְּבֵית אֶרֶץ אֲחֻזַּתְכֶם. וּבָא אֲשֶׁר־לוֹ הַבַּיִת וְהִגִּיד לַכֹּהֵן לֵאמֹר כְּנֶגַע נִרְאָה לִי בַּבָּיִת.",e:"When you come into the land of Canaan which I give you as a possession, I will place a tzara'as nega in a house of the land of your possession. The owner of the house comes and tells the Kohen: something like a nega has appeared to me in the house.",rh:"ונתתי נגע צרעת — בשורה היא להם שהנגעים באים עליהם, לפי שהטמינו אמוריים מטמוניות של זהב בקירות בתיהם, ועל ידי הנגע נותץ הבית ומוצאן. כנגע נראה לי — אפילו תלמיד חכם שיודע שהוא נגע ודאי, לא יפסוק דבר ברור לומר נגע נראה לי, אלא כנגע נראה לי.",re:"'I will place a nega' — good news: the Emorim hid gold treasures in their walls; through the nega he demolishes the house and finds them. 'Like a nega' — even a talmid chacham certain it is a nega says 'something like a nega', not 'a nega'."},
"יד:לו":{h:"וְצִוָּה הַכֹּהֵן וּפִנּוּ אֶת־הַבַּיִת בְּטֶרֶם יָבֹא הַכֹּהֵן לִרְאוֹת אֶת־הַנֶּגַע וְלֹא יִטְמָא כָּל־אֲשֶׁר בַּבָּיִת וְאַחַר כֵּן יָבֹא הַכֹּהֵן לִרְאוֹת אֶת־הַבָּיִת.",e:"The Kohen orders the house emptied before the Kohen comes to see the nega, so that everything in the house not become tamei; afterwards the Kohen comes to see the house.",rh:"שאם לא יפנהו ויבא הכהן ויראה הנגע, נזקק להסגר, וכל מה שבתוכו יטמא. ועל מה חסה תורה? על כלי חרסו, שאין להם טהרה במקוה.",re:"If not emptied first, once the Kohen sees it and confines, everything inside becomes tamei. What did the Torah spare? His earthenware — which has no taharah in a mikveh."},
"יד:לז":{h:"וְרָאָה אֶת־הַנֶּגַע וְהִנֵּה הַנֶּגַע בְּקִירֹת הַבַּיִת שְׁקַעֲרוּרֹת יְרַקְרַקֹּת אוֹ אֲדַמְדַּמֹּת וּמַרְאֵיהֶן שָׁפָל מִן־הַקִּיר.",e:"He sees the nega: in the walls of the house — sunken streaks, deep green or deep red, their appearance lower than the wall.",rh:"שקערורות — שוקעות במראיהן.",re:"Shekaruros — sunken in their appearance."},
"יד:מג-מה":{h:"וְאִם־יָשׁוּב הַנֶּגַע וּפָרַח בַּבַּיִת... צָרַעַת מַמְאֶרֶת הִוא בַּבַּיִת טָמֵא הוּא. וְנָתַץ אֶת־הַבַּיִת אֶת־אֲבָנָיו וְאֶת־עֵצָיו וְאֵת כָּל־עֲפַר הַבָּיִת וְהוֹצִיא אֶל־מִחוּץ לָעִיר אֶל־מָקוֹם טָמֵא.",e:"If the nega returns and erupts in the house... it is a mameres tzara'as in the house — it is tamei. He demolishes the house — its stones, its wood, and all the plaster of the house — and takes it outside the city to a tamei place."},
"יד:מח":{h:"וְאִם־בֹּא יָבֹא הַכֹּהֵן וְרָאָה וְהִנֵּה לֹא־פָשָׂה הַנֶּגַע בַּבַּיִת אַחֲרֵי הִטֹּחַ אֶת־הַבָּיִת וְטִהַר הַכֹּהֵן אֶת־הַבַּיִת כִּי נִרְפָּא הַנָּגַע.",e:"If the Kohen comes and sees that the nega did not spread in the house after the house was replastered, the Kohen declares the house tahor, for the nega has healed."},
"יד:מח-נג":{h:"וְלָקַח לְחַטֵּא אֶת־הַבַּיִת שְׁתֵּי צִפֳּרִים וְעֵץ אֶרֶז וּשְׁנִי תוֹלַעַת וְאֵזֹב... וְשִׁלַּח אֶת־הַצִּפֹּר הַחַיָּה אֶל־מִחוּץ לָעִיר אֶל־פְּנֵי הַשָּׂדֶה וְכִפֶּר עַל־הַבַּיִת וְטָהֵר.",e:"To purge the house he takes two birds, cedar wood, scarlet thread, and hyssop... he sends the live bird outside the city over the open field, atones for the house, and it is tahor."}};
const MN={"נגעים א:א":{h:"מראות נגעים שנים שהן ארבע. בהרת עזה כשלג, שנייה לה כסיד ההיכל. השאת כקרום ביצה, שנייה לה כצמר לבן — ר׳ מאיר. וחכמים: השאת כצמר לבן, שנייה כקרום ביצה.",e:"Appearances: two that are four. Baheres=snow, secondary=plaster. R' Meir: S'eis=egg, secondary=wool. Chachamim: S'eis=wool, secondary=egg."},"נגעים ב:ב":{h:"אין רואין הנגעים בשחרית ולא בין הערביים, ולא בתוך הבית, ולא ביום המעונן. ולא בצהרים.",e:"Not examined early morning, late afternoon, indoors, cloudy, or midday."},"נגעים ב:ה":{h:"כל הנגעים אדם רואה, חוץ מנגעי עצמו. ר׳ מאיר: אף לא נגעי קרוביו.",e:"One may examine all except his own. R' Meir: not even relatives'."},"נגעים ג:א":{h:"הכל כשרים לראות, אלא שהטומאה והטהרה בידי כהן.",e:"Everyone qualified to examine, but tumah/taharah through a Kohen."},"נגעים ג:ג":{h:"עוֹר הַבָּשָׂר מִטַּמֵּא בִשְׁנֵי שָׁבוּעוֹת וּבִשְׁלשָׁה סִימָנִין, בְּשֵׂעָר לָבָן וּבְמִחְיָה וּבְפִסְיוֹן. בְּשֵׂעָר לָבָן וּבְמִחְיָה, בַּתְּחִלָּה, וּבְסוֹף שָׁבוּעַ רִאשׁוֹן, וּבְסוֹף שָׁבוּעַ שֵׁנִי, לְאַחַר הַפְּטוּר. וּבְפִסְיוֹן, בְּסוֹף שָׁבוּעַ רִאשׁוֹן, וּבְסוֹף שָׁבוּעַ שֵׁנִי, לְאַחַר הַפְּטוּר. וּמִטַּמֵּא בִשְׁנֵי שָׁבוּעוֹת, שֶׁהֵן שְׁלשָׁה עָשָׂר יוֹם.",e:"Skin of the flesh becomes tamei over two weeks and through three signs: white hair, michya, and spreading. White hair and michya — at the outset, at the end of week one, at the end of week two, and after release; spreading — at the end of week one, at the end of week two, and after release. Two weeks, meaning thirteen days."},"נגעים ג:ד":{h:"שחין ומכוה — מסגירן שבעת ימים. פשה — טמא, לאו — טהור.",e:"Shechin/burn — confine 7 days. Spread=tamei; not=tahor."},"נגעים ג:ה":{h:"הפשיון — סימן טומאה בכל הנגעים.",e:"Spreading — tumah sign in all nega'im."},"נגעים ד:ג":{h:"המחיה סימן טומאה בנגעי עור הבשר.",e:"Michya — tumah sign in skin nega'im."},"נגעים ד:ד":{h:"שער לבן סימן טומאה. ומיעוט שער — שתים.",e:"White hair — tumah sign. Minimum: two hairs."},"נגעים ד:יא":{h:"ספק שקדם שער ספק שקדמה בהרת — טמא. ר׳ יהושע: כהה.",e:"Uncertain order: tamei. R' Yehoshua: keihah."},"נגעים ו:א":{h:"שיעור בהרת — כגריס הקלקי מרובע.",e:"Minimum: Cilician gris, squared."},"נגעים ח:א":{h:"הפורח מן הטמא — טהור. מן הטהור — טמא.",e:"Covers tamei person — tahor. Covers tahor person — tamei."},"נגעים ט:א":{h:"השחין והמכוה — מיטמאין בשבוע אחד בשני סימנין.",e:"Shechin/burn — tamei through 1 week, 2 signs."},"נגעים י:א":{h:"הנתקים — מיטמאין בשער צהוב דק ובפשיון.",e:"Nesakim — tamei by thin yellow hair and spreading."},"נגעים י:ה":{h:"מגלח חוצה לו, כדי שיהא הפשיון ניכר.",e:"Shave outside it so spreading is visible."},"נגעים י:ט":{h:"שער שחור מציל בנתק. שיעורו — שתי שערות.",e:"Black hair saves in nesek. Minimum: 2 hairs."},"נגעים י:י":{h:"הקרחת והגבחת — במחיה ובפשיון, שני שבועות.",e:"Karachas/gabachas — michya and spreading, two weeks."},"נגעים יא:א":{h:"בגדי צמר ופשתים — מיטמאין בנגעים.",e:"Wool/linen garments become tamei."},"נגעים יג:יב":{h:"כל זמן שהוא מוחלט — בגדיו פרומים וראשו פרוע.",e:"While muchlat — clothes torn, head unshorn."},
...
function heNum(s){s=String(s||"").replace(/[׳״'"]/g,"");const v={"א":1,"ב":2,"ג":3,"ד":4,"ה":5,"ו":6,"ז":7,"ח":8,"ט":9,"י":10,"כ":20,"ך":20,"ל":30,"מ":40,"ם":40,"נ":50,"ן":50,"ס":60,"ע":70,"פ":80,"ף":80,"צ":90,"ץ":90,"ק":100,"ר":200,"ש":300,"ת":400};let n=0;for(const c of s)n+=v[c]||0;return n||null;}
function srcUrl(type,refKey){
  if(type==="sifra")return tkUrl(refKey);
  if(type==="pasuk"){const k=parsePasuk(refKey);if(!k)return null;const p=k.split(":");const ch=heNum(p[0]),vs=heNum((p[1]||"").split(/[-,–]/)[0]);return ch&&vs?`https://www.sefaria.org/Leviticus.${ch}.${vs}`:null;}
  if(type==="mishnah"){const k=String(refKey).replace("נגעים ","");const p=k.split(":");const ch=heNum(p[0]),ms=heNum(p[1]);return ch&&ms?`https://www.sefaria.org/Mishnah_Negaim.${ch}.${ms}`:null;}
  if(type==="rambam"){const p=String(refKey).split(":");const ch=heNum(p[0]),hl=heNum(p[1]);return ch&&hl?`https://www.sefaria.org/Mishneh_Torah,_Defilement_by_Leprosy.${ch}.${hl}`:null;}
  return null;}
...
{(type==="mishnah"||type==="rambam")&&<div style={{fontSize:11,color:"var(--t3)",direction:"rtl",textAlign:"right",margin:"-6px 0 10px"}}>{tx(lang,'הנוסח כאן ע"פ המקור — הלשון המלא בספריא',"Text follows the source — full wording on Sefaria")}</div>}
{su&&<a href={su} target="_blank" rel="noopener noreferrer" style={{display:"inline-block",fontFamily:"var(--fm)",fontSize:11,color:"var(--ac)",textDecoration:"none",borderBottom:"1px dotted var(--ac)",marginBottom:8}}>{tx(lang,"לצפייה בספריא ↗","View on Sefaria ↗")}</a>}
{type==="pasuk"&&data.rh&&<><div style={{fontSize:13,fontWeight:600,color:"var(--ac)",marginBottom:8}}>{tx(lang,'ע"פ רש"י',"Rashi (abridged)")}</div>
