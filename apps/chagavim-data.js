  ...
  talmud: {
    ...
    sugyot: [
      ...
      },
      {
        ...
        badge: "direct", research: "complete",
        ref: "Mishnah Avodah Zarah 2:7 · Bavli 39b", sefaria: "https://www.sefaria.org/Avodah_Zarah.39b.14",
      ...
      {
        id: "live-locust",
        topic: { he: "חָגָב חַי — מִשְׂחָק וּסְגֻלָּה", se: "A live locust", en: "Keeping a live locust" },
        he: "חָגָב חַי טָהוֹר — כׇּל שֶׁהוּא. מֵת — כִּגְרוֹגֶרֶת. צִפּוֹרֶת כְּרָמִים, בֵּין חַיָּה בֵּין מֵתָה — כׇּל שֶׁהוּא, שֶׁמַּצְנִיעִין אוֹתָהּ לִרְפוּאָה. רַבִּי יְהוּדָה אוֹמֵר: אַף הַמּוֹצִיא חָגָב חַי טָמֵא כׇּל שֶׁהוּא, שֶׁמַּצְנִיעִין אוֹתוֹ לְקָטָן לִשְׂחוֹק בּוֹ.",
        en: "A live kosher locust — [the carrying-measure is] any amount; a dead one — a fig-bulk, as food. The tzipporet keramim, alive or dead — any amount, since it is kept for healing. R. Yehuda says: even one who carries out a live NON-kosher locust [is liable for] any amount, since it is kept for a child to play with.",
        badge: "direct", research: "complete",
        ref: "Shabbat 90b", sefaria: "https://www.sefaria.org/Shabbat.90b.1",
        note_en: "The Gemara (90b) adds: Rav told Rav Kahana to put down a live kosher locust he had passed by his mouth, lest people say he was eating it alive and transgressing 'bal teshaktzu' — eating a live locust is forbidden.",
        note_he: "הַגְּמָרָא (צ ע״ב) מוֹסִיפָה: רַב אָמַר לְרַב כָּהֲנָא לְהַנִּיחַ חָגָב חַי טָהוֹר שֶׁהֶעֱבִירוֹ עַל פִּיו, שֶׁלֹּא יֹאמְרוּ אוֹכְלוֹ חַי וְעוֹבֵר עַל ׳בַּל תְּשַׁקְּצוּ׳ — אֲכִילַת חָגָב חַי אֲסוּרָה.",
      },
      {
        id: "tumas-ochlin",
        topic: { he: "חָגָב כְּאֹכֶל לְטֻמְאָה", se: "Locust as food", en: "Locust as 'food' for impurity" },
        he: "דָּגִים טְמֵאִים וַחֲגָבִים טְמֵאִים, צְרִיכִין מַחֲשָׁבָה בַּכְּפָרִים.",
        en: "Non-kosher fish and non-kosher locusts require designation of intent (machshavah) — and in villages — before they can contract food-impurity.",
        badge: "direct", research: "complete",
        ref: "Mishnah Oktzin 3:9", sefaria: "https://www.sefaria.org/Mishnah_Oktzin.3.9",
        note_en: "Since non-kosher fish and locusts are not ordinarily treated as food, they become susceptible to food-impurity only once a person intends to eat them — a sign of how the locust sits right on the boundary of 'food.'",
        note_he: "לְפִי שֶׁדָּגִים וַחֲגָבִים טְמֵאִים אֵינָם נֶחְשָׁבִים אֹכֶל מִמֵּילָא, אֵינָם מְקַבְּלִים טֻמְאַת אֳכָלִין אֶלָּא לְאַחַר מַחֲשָׁבָה — עֵדוּת לְמַעֲמַד הֶחָגָב עַל גְּבוּל ׳אֹכֶל׳.",
      },
      {
        id: "yerushalmi-brine",
        topic: { he: "יְרוּשַׁלְמִי — צִיר חֲגָבִים", se: "Yerushalmi — brine", en: "Yerushalmi — locust brine" },
        he: "חֲגָבִים טְמֵאִים שֶׁנִּכְבְּשׁוּ עִם חֲגָבִים טְהוֹרִים לֹא פָסְלוּ אֶת צִירָן. הֵעִיד רִבִּי צָדוֹק עַל צִיר חֲגָבִים טְמֵאִים שֶׁהוּא טָהוֹר.",
        en: "Non-kosher locusts pickled together with kosher locusts do not disqualify their brine. R. Tzadok testified that the brine of non-kosher locusts is pure.",
        badge: "direct", research: "complete",
        ref: "Yerushalmi Terumot 10:5", sefaria: "https://www.sefaria.org/Jerusalem_Talmud_Terumot.10.5.1",
        note_en: "The Yerushalmi sets R. Tzadok's testimony (also Eduyot 7:2) in context: unlike non-kosher FISH brine, locust brine stays permitted even when non-kosher locusts were pickled in it — because locusts exude no moisture.",
        note_he: "הַיְרוּשַׁלְמִי מַעֲמִיד אֶת עֵדוּת רַבִּי צָדוֹק (וְעֵדֻיּוֹת ז׳ ב׳) בְּהֶקְשֵׁרָהּ: שֶׁלֹּא כְּצִיר דָּגִים טְמֵאִים, צִיר חֲגָבִים נִשְׁאָר מֻתָּר אַף שֶׁנִּכְבְּשׁוּ בּוֹ טְמֵאִים — שֶׁאֵין בָּהֶם לִחְלוּחִית.",
      },
    ],
  },

  /* ============================================================================
     CODIFIED HALACHA — Rambam, Tur, Shulchan Arukh, Arukh HaShulchan on YD 85.
     Verbatim (Sefaria). Hebrew-only sources carry en:null + an English note.
     ========================================================================== */
  poskim: {
    title: { he: "הֲלָכָה — פּוֹסְקִים", se: "Halacha — codifiers", en: "Codified Halacha" },
    intro: {
      he: `מִן הַתַּלְמוּד אֶל הַפְּסָק: הָרַמְבַּ״ם, הַטּוּר וְהַשֻּׁלְחָן עָרוּךְ — וְעַד הַמִּנְהָג שֶׁאֵין אוֹכְלִין חֲגָבִים בִּזְמַנֵּנוּ אֶלָּא בְּמָסֹרֶת.`,
      en: `From Talmud to ruling: Rambam, the Tur, and the Shulchan Arukh — through to the practice today of eating no locust at all without a received tradition.`,
    },
    items: [
      { id: "rambam-21", label: { he: `רַמְבַּ״ם — שְׁמוֹנֶה מִינִים`, en: "Rambam — the eight species" },
        ref: "Mishneh Torah, Forbidden Foods 1:21", sefaria: "https://www.sefaria.org/Mishneh_Torah,_Forbidden_Foods.1.21",
        he: `וּמִינֵי חֲגָבִים שֶׁהִתִּירָה תּוֹרָה שְׁמוֹנָה. וְאֵלּוּ הֵן. חָגָב. וּמִין חָגָב וְהוּא הָרַזְבָנִית. חַרְגֹּל. וּמִין חַרְגֹּל וְהוּא עַרְצוּבְיָא. אַרְבֶּה. וּמִין אַרְבֶּה וְהִיא צִפֹּרֶת כְּרָמִים. סָלְעָם. וּמִין סָלְעָם וְהִיא יוֹחָנָא יְרוּשַׁלְמִית׃`,
        en: `There are eight species of locust which the Torah permitted: the chagav, and a member of its family — the razbanit; the chargol, and its family member — the artzuvya; the arbeh, and its family member — the tzipporet keramim (vineyard-bird); the sol'am, and its family member — the Jerusalem yochana.` },
      { id: "rambam-22", label: { he: `רַמְבַּ״ם — שְׁלֹשֶׁת הַסִּימָנִים וְהַשֵּׁם`, en: "Rambam — the three signs & the name" },
        ref: "Mishneh Torah, Forbidden Foods 1:22", sefaria: "https://www.sefaria.org/Mishneh_Torah,_Forbidden_Foods.1.22",
        he: `מִי שֶׁהוּא בָּקִי בָּהֶן וּבִשְׁמוֹתֵיהֶן אוֹכֵל. וְהַצַּיָּד נֶאֱמָן עֲלֵיהֶן כְּעוֹף. וּמִי שֶׁאֵינוֹ בָּקִי בָּהֶן בּוֹדֵק בְּסִימָנִין. וּשְׁלֹשָׁה סִימָנִין יֵשׁ בָּהֶן. כָּל שֶׁיֵּשׁ לוֹ אַרְבַּע רַגְלַיִם, וְאַרְבַּע כְּנָפַיִם שֶׁחוֹפוֹת רֹב אֹרֶךְ גּוּפוֹ וְרֹב הֶקֵּף גּוּפוֹ, וְיֵשׁ לוֹ שְׁנֵי כְּרָעַיִם לְנַתֵּר בָּהֶם — הֲרֵי זֶה מִין טָהוֹר. וְאַף עַל פִּי שֶׁרֹאשׁוֹ אָרֹךְ וְיֵשׁ לוֹ זָנָב, אִם הָיָה שְׁמוֹ חָגָב — טָהוֹר׃`,
        en: `One expert in the species and their names may eat them, and a hunter is believed about them as with a bird. One who is not expert checks by signs. They have three signs: four legs; four wings covering most of the body's length and circumference; and two jumping legs — it is a kosher species. Even if its head is long and it has a tail, if its name is chagav, it is kosher.` },
      { id: "rambam-23", label: { he: `רַמְבַּ״ם — חָגָב שֶׁעָתִיד לְגַדֵּל`, en: "Rambam — the immature locust" },
        ref: "Mishneh Torah, Forbidden Foods 1:23", sefaria: "https://www.sefaria.org/Mishneh_Torah,_Forbidden_Foods.1.23",
        he: `מִי שֶׁאֵין לוֹ עַכְשָׁו כְּנָפַיִם אוֹ כְּרָעַיִם, אוֹ שֶׁאֵין לוֹ כְּנָפַיִם הַחוֹפִין אֶת רֻבּוֹ, וְעָתִיד לְגַדֵּל אוֹתָן אַחַר זְמַן כְּשֶׁיַּגְדִּיל — הֲרֵי זֶה מֻתָּר מֵעַתָּה׃`,
        en: `A locust that now lacks wings or jumping legs, or whose wings do not yet cover most of it, but will grow them later when it matures — is already permitted now.` },
      { id: "sa-85-1", label: { he: `שֻׁלְחָן עָרוּךְ יו״ד פ״ה`, en: "Shulchan Arukh, Yoreh De'ah 85:1" },
        ref: "Shulchan Arukh, Yoreh De'ah 85:1", sefaria: "https://www.sefaria.org/Shulchan_Arukh,_Yoreh_De'ah.85.1",
        he: `סִימָנֵי חֲגָבִים: כָּל שֶׁיֵּשׁ לוֹ אַרְבַּע רַגְלַיִם וְאַרְבַּע כְּנָפַיִם, וּכְנָפָיו חוֹפִין אֶת רֹב אֹרֶךְ גּוּפוֹ וְרֹב הֶקֵּפוֹ, וְיֵשׁ לוֹ שְׁתֵּי כְּרָעַיִם לְנַתֵּר בָּהֶם, וַאֲפִלּוּ אֵין לוֹ עַכְשָׁו וְעָתִיד לְגַדְּלָם לְאַחַר זְמַן. וְאַף עַל פִּי שֶׁיֵּשׁ בּוֹ כָּל הַסִּימָנִים הַלָּלוּ, אֵינוֹ מֻתָּר אֶלָּא אִם כֵּן שְׁמוֹ חָגָב, אוֹ שֶׁיֵּשׁ לָהֶם מָסֹרֶת שֶׁשְּׁמוֹ חָגָב׃`,
        en: `Signs of locusts: any that has four legs and four wings, whose wings cover most of its body's length and circumference, and has two jumping legs (even if it lacks them now but will grow them later). And even if it has all these signs, it is not permitted unless its name is chagav, or they have a tradition (mesorah) that its name is chagav.` },
      { id: "tur-85", label: { he: `טוּר יו״ד פ״ה — וְהָאִידְנָא`, en: "Tur, Yoreh De'ah 85 — 'and nowadays'" },
        ref: "Tur, Yoreh De'ah 85", sefaria: "https://www.sefaria.org/Tur,_Yoreh_De'ah.85", en: null,
        he: `…וְצָרִיךְ שֶׁיְּהֵא שְׁמוֹ חָגָב… וְכָתַב אֲדוֹנִי אָבִי הָרֹא״שׁ ז״ל: וְהָאִידְנָא אֲפִלּוּ חָגָב הַבָּא בְּד׳ סִימָנִין אֵין לְאָכְלוֹ אֶלָּא בְּמָסֹרֶת שֶׁשְּׁמוֹ חָגָב. חֲגָבִים אֵין טְעוּנִים שְׁחִיטָה. כָּתַב הָרַמְבַּ״ם: אַף עַל פִּי שֶׁצִּיר דָּגִים טְמֵאִים אָסוּר, צִיר חָגָב טָמֵא מֻתָּר, שֶׁאֵין בָּהֶן לִחְלוּחִית׃`,
        note_en: `The Tur restates the signs and the name requirement, then quotes his father, the Rosh: nowadays even a locust bearing all four signs may not be eaten except by an established tradition that it is called chagav. He adds that locusts need no sheḥitah, and (per Rambam) that the brine of a non-kosher locust is permitted, since locusts have no exuding moisture.`,
        note_he: `הַטּוּר חוֹזֵר עַל הַסִּימָנִים וְהַשֵּׁם, וּמֵבִיא אֶת הָרֹא״שׁ אָבִיו: הָאִידְנָא אֲפִלּוּ חָגָב בְּד׳ סִימָנִין אֵין אוֹכְלִין אֶלָּא בְּמָסֹרֶת. וּמוֹסִיף שֶׁחֲגָבִים אֵינָם טְעוּנִים שְׁחִיטָה, וְצִיר חָגָב טָמֵא מֻתָּר.` },
      { id: "ahs-85-5", label: { he: `עֲרוּךְ הַשֻּׁלְחָן — מִנְהָג זְמַנֵּנוּ`, en: "Arukh HaShulchan YD 85:5 — practice today" },
        ref: "Arukh HaShulchan, Yoreh De'ah 85:5", sefaria: "https://www.sefaria.org/Arukh_HaShulchan,_Yoreh_De'ah.85.5", en: null,
        he: `…וְעַכְשָׁו אָנוּ נוֹהֲגִין שֶׁלֹּא לֶאֱכֹל שׁוּם חָגָב אֲפִלּוּ בְּכָל הַסִּימָנִים, וַאֲפִלּוּ יָדוּעַ שֶׁשְּׁמוֹ חָגָב… וּמִיָּמֵינוּ לֹא שָׁמַעְנוּ שֶׁיְּהֵא מָקוֹם שֶׁאוֹכְלִין בּוֹ חֲגָבִים׃`,
        note_en: `The Arukh HaShulchan's bottom line on present practice: "Nowadays we are accustomed not to eat any locust even with all the signs, and even when it is known that its name is chagav… and in our days we have not heard of a place where locusts are eaten." (The exception is the Yemenite community, which preserved a continuous tradition.)`,
        note_he: `שׁוּרַת הַמַּעֲשֶׂה: ״עַכְשָׁו אָנוּ נוֹהֲגִין שֶׁלֹּא לֶאֱכֹל שׁוּם חָגָב… וּמִיָּמֵינוּ לֹא שָׁמַעְנוּ שֶׁיְּהֵא מָקוֹם שֶׁאוֹכְלִין בּוֹ חֲגָבִים״. הַיּוֹצֵא מִן הַכְּלָל — בְּנֵי תֵּימָן שֶׁשָּׁמְרוּ מָסֹרֶת.` },
    ],
  },
  ...
  tanach: {
    ...
    groups: [
      { cat: { he: "תּוֹרָה", en: "Torah" }, items: [
        ...
        { id: "devarim-38", label: { he: "תּוֹכֵחָה — כִּי יַחְסְלֶנּוּ הָאַרְבֶּה", en: "Tochacha — 'the locust will consume it'" }, word: "אַרְבֶּה",
          ref: "Deuteronomy 28:38", sefaria: "https://www.sefaria.org/Deuteronomy.28.38",
          he: "זֶרַע רַב תּוֹצִיא הַשָּׂדֶה וּמְעַט תֶּאֱסֹף כִּי יַחְסְלֶנּוּ הָאַרְבֶּה׃",
          en: "You shall carry much seed out to the field but gather in little, for the locust (ha-arbeh) shall consume it.",
          gist_en: "The curse of Devarim: abundant sowing, scant harvest — the arbeh devours the crop." },
        { id: "devarim-42", label: { he: "יְיָרֵשׁ הַצְּלָצַל", en: "'The tzelatzal shall possess'" }, word: "צְלָצַל",
          ref: "Deuteronomy 28:42", sefaria: "https://www.sefaria.org/Deuteronomy.28.42",
          he: "כׇּל־עֵצְךָ וּפְרִי אַדְמָתֶךָ יְיָרֵשׁ הַצְּלָצַל׃",
          en: "All your trees and the produce of your land the tzelatzal (locust) shall take over.",
          gist_en: "The tzelatzal — another of the eight names the Hoshana invokes — seizes the trees and produce." },
      ]},
      { cat: { he: "נְבִיאִים", en: "Prophets" }, items: [
        ...
        { id: "melachim", label: { he: "תְּפִלַּת שְׁלֹמֹה — אַרְבֶּה חָסִיל", en: "Solomon's prayer — arbeh, chasil" }, word: "אַרְבֶּה · חָסִיל",
          ref: "I Kings 8:37", sefaria: "https://www.sefaria.org/I_Kings.8.37",
          he: "רָעָב כִּי־יִהְיֶה בָאָרֶץ דֶּבֶר כִּי־יִהְיֶה שִׁדָּפוֹן יֵרָקוֹן אַרְבֶּה חָסִיל כִּי יִהְיֶה כִּי יָצַר־לוֹ אֹיְבוֹ בְּאֶרֶץ שְׁעָרָיו כׇּל־נֶגַע כׇּל־מַחֲלָה׃",
          en: "If there is famine in the land, pestilence, blight, mildew, locust (arbeh) or caterpillar (chasil)… any plague, any sickness —",
          gist_en: "At the Temple's dedication Shlomo names the arbeh and chasil among the plagues to pray over (parallel to II Chronicles 7:13)." },
      ]},
      ...
      { cat: { he: "אַגָּדָה — הַמְּרַגְּלִים", en: "Aggada — the spies" }, items: [
        { id: "sotah", label: { he: "סוֹטָה לה. — וְכֵן הָיִינוּ בְּעֵינֵיהֶם", en: "Sotah 35a — 'and so we were in their eyes'" }, word: "חֲגָבִים",
          ref: "Sotah 35a", sefaria: "https://www.sefaria.org/Sotah.35a",
          he: "״וַנְּהִי בְעֵינֵינוּ כַּחֲגָבִים וְכֵן הָיִינוּ וְגוֹ׳״, אָמַר רַב מְשַׁרְשְׁיָא: מְרַגְּלִים שַׁקָּרֵי הֲווֹ, בִּשְׁלָמָא ״וַנְּהִי בְּעֵינֵינוּ כַּחֲגָבִים״ — לְחַיֵּי, אֶלָּא ״וְכֵן הָיִינוּ בְּעֵינֵיהֶם״ מְנָא הֲווֹ יָדְעִי? וְלָא הִיא, כִּי הֲווֹ מַבְרִי אֲבֵילֵי תּוּתֵי אַרְזֵי הֲווֹ מַבְרִי, וְכִי חֲזִינְהוּ סְלִיקוּ יָתְבִי בְּאִילָנֵי, שָׁמְעִי דְּקָאָמְרִי: קָחָזֵינַן אִינָשֵׁי דְּדָמוּ לְקַמְצֵי בְּאִילָנֵי.",
          en: "Rav Mesharshiyya said: the spies were liars. 'We were like grasshoppers in our own eyes' — fine; but 'and so we were in their eyes' — how could they know? The Gemara resolves: when the Canaanites held the mourners' meal beneath the cedars, the spies climbed up and sat in the trees, and heard them say: we see people who look like grasshoppers in the trees.",
          gist_en: "The Gemara probes the spies' claim that the giants saw them as grasshoppers — and resolves it: they overheard exactly that from the trees." },
        { id: "bamidbar-rabbah", label: { he: "בְּמִדְבַּר רַבָּה — וִתַּרְתִּי עֲלֵיהֶם", en: "Bamidbar Rabbah — 'maybe you looked like angels'" }, word: "חֲגָבִים",
          ref: "Bamidbar Rabbah 16:11", sefaria: "https://www.sefaria.org/Bamidbar_Rabbah.16.11",
          he: "אָמְרוּ: וַנְהִי בְעֵינֵינוּ כַּחֲגָבִים, אָמַר הַקָּדוֹשׁ בָּרוּךְ הוּא וִתַּרְתִּי עֲלֵיהֶם, אֶלָּא וְכֵן הָיִינוּ בְּעֵינֵיהֶם — יוֹדְעִים הֱיִיתֶם מֶה עָשִׂיתִי אֶתְכֶם לְעֵינֵיהֶם, מִי יֹאמַר שֶׁלֹּא הֱיִיתֶם בְּעֵינֵיהֶם כְּמַלְאָכִים? מַה גְּרַמְתֶּם לְעַצְמְכֶם.",
          en: "They said, 'We were like grasshoppers in our own eyes.' God said: I overlook that. But 'and so we were in their eyes' — did you know what I made you look like to them? Who says you did not appear to them like angels? What you have brought upon yourselves!",
          gist_en: "The midrash sharpens the rebuke: their self-image as grasshoppers became a self-fulfilling defeat — they may have looked like angels to the giants." },
      ]},
      { cat: { he: "תְּפִלָּה וְשִׁירָה", en: "Liturgy & song" }, items: [
        ...
        { id: "ps-tzipporet", label: { he: "פֶּרֶק שִׁירָה — צִיפּוֹרֶת כְּרָמִים", en: "Perek Shirah — the tzipporet keramim" }, word: "צִיפּוֹרֶת כְּרָמִים",
          ref: "Perek Shirah 4:26", sefaria: "https://www.sefaria.org/Perek_Shirah.4.26",
          he: "צִיפֹּרֶת כְּרָמִים אוֹמֶרֶת: אֶשָּׂא עֵינַי אֶל הֶהָרִים מֵאַיִן יָבֹא עֶזְרִי׃",
          en: "The tzipporet keramim (vineyard-hopper) says: 'I lift my eyes to the mountains — from where will my help come?' (Psalms 121:1).",
          gist_en: "Perek Shirah assigns a verse to the tzipporet keramim — which is the arbeh's sub-species ('its kind') in Chullin 65 and the species kept for healing in Shabbos 90b." },
        { id: "ps-chasil", label: { he: "פֶּרֶק שִׁירָה — חָסִיל", en: "Perek Shirah — the chasil" }, word: "חָסִיל",
          ref: "Perek Shirah 4:27", sefaria: "https://www.sefaria.org/Perek_Shirah.4.27",
          he: "חָסִיל אוֹמֵר: ה׳ אֱלֹהַי אַתָּה אֲרוֹמִמְךָ אוֹדֶה שִׁמְךָ כִּי עָשִׂיתָ פֶּלֶא עֵצוֹת מֵרָחוֹק אֱמוּנָה אֹמֶן׃",
          en: "The chasil (locust) says: 'Hashem, You are my God; I exalt You, I praise Your name, for You have done wonders' (Isaiah 25:1).",
          gist_en: "The chasil — the locust that closes Joel's quartet and the Hoshana acrostic — is given its own song of praise. Neither name here is literally 'chagav,' but both belong to the locust family of our sugya." },
      ]},
    ],
  },
};
