...
const DATA = [
  ...
  { cat: "Festivals", occ: { en: "Pesach · Day 8 (diaspora)", he: "פֶּסַח · יוֹם ח׳" },
    torah: [{ label: { en: "Kol HaB'chor", he: "כָּל הַבְּכוֹר" }, range: "Deut. 15:19–16:17" }],
    haftarot: [{ trad: "All", layer: "baraita", inc: "עוֹד הַיּוֹם בְּנֹב לַעֲמֹד", en: "Isaiah’s Messianic prophecy", range: "Isaiah 10:32–12:6" }],
    reason: { text: { en: "The last day of Pesach is linked to the future redemption, so the haftarah is Isaiah’s prophecy of the Messianic king.", he: "יוֹם טוֹב הָאַחֲרוֹן שֶׁל פֶּסַח עִנְיָנוֹ הַגְּאֻלָּה הָעֲתִידָה, וְלָכֵן מַפְטִירִין בִּנְבוּאַת הַמָּשִׁיחַ שֶׁבִּישַׁעְיָה." }, src: S.meg31a },
    change: null, flags: [], sources: [S.meg31a, S.ram(8)],
    heb: "עוֹד הַיּוֹם בְּנֹב לַעֲמֹד, יְנֹפֵף יָדוֹ הַר בַּת צִיּוֹן גִּבְעַת יְרוּשָׁלִָם.", hebSrc: { en: "Isaiah 10:32–12:6; Megillah 31a", he: "יְשַׁעְיָה י׳:לב–י״ב:ו; מְגִלָּה ל״א." } },
  ...
  { cat: "Festivals", occ: { en: "Sukkot · Day 2 (diaspora)", he: "סֻכּוֹת · יוֹם ב׳" },
    torah: [{ label: { en: "Parashat Mo'adot", he: "פָּרָשַׁת מוֹעֲדוֹת" }, range: "Lev. 22:26–23:44" }],
    haftarot: [{ trad: "All", layer: "baraita", inc: "וַיִּקָּהֲלוּ אֶל הַמֶּלֶךְ שְׁלֹמֹה", en: "Solomon’s dedication assembly", range: "I Kings 8:2–21" }],
    reason: { text: { en: "Solomon assembled Israel for the Temple’s dedication on the festival of Sukkot.", he: "שְׁלֹמֹה הִקְהִיל אֶת יִשְׂרָאֵל לַחֲנֻכַּת הַבַּיִת בְּחַג הַסֻּכּוֹת." }, src: S.meg31a },
    change: null, flags: [], sources: [S.meg31a, S.ram(12)],
    heb: "וַיִּקָּהֲלוּ אֶל הַמֶּלֶךְ שְׁלֹמֹה כָּל אִישׁ יִשְׂרָאֵל בְּיֶרַח הָאֵתָנִים בֶּחָג, הוּא הַחֹדֶשׁ הַשְּׁבִיעִי.", hebSrc: { en: "I Kings 8:2–21; Megillah 31a", he: "מְלָכִים א׳ ח׳:ב–כא; מְגִלָּה ל״א." } },
  { cat: "Festivals", occ: { en: "Sukkot · Shabbat Chol HaMoed", he: "סֻכּוֹת · שַׁבָּת חוֹל הַמּוֹעֵד" },
    torah: [{ label: { en: "Re'eh Atah", he: "רְאֵה אַתָּה" }, range: "Ex. 33:12–34:26" }],
    haftarot: [{ trad: "All", layer: "baraita", inc: "וְהָיָה בַּיּוֹם הַהוּא בְּיוֹם בּוֹא גוֹג", en: "The war of Gog", range: "Ezekiel 38:18–39:16" }],
    reason: { text: { en: "The war of Gog is foretold to occur in Tishrei, the month of Sukkot.", he: "מִלְחֶמֶת גּוֹג עֲתִידָה לִהְיוֹת בְּתִשְׁרֵי, חֹדֶשׁ הֶחָג." }, src: S.meg31a },
    change: null, flags: [], sources: [S.meg31a],
    heb: "וְהָיָה בַּיּוֹם הַהוּא בְּיוֹם בּוֹא גוֹג עַל אַדְמַת יִשְׂרָאֵל, נְאֻם אֲדֹנָי ה׳.", hebSrc: { en: "Ezekiel 38:18–39:16; Megillah 31a", he: "יְחֶזְקֵאל ל״ח:יח–ל״ט:טז; מְגִלָּה ל״א." } },
  { cat: "Festivals", occ: { en: "Shemini Atzeret", he: "שְׁמִינִי עֲצֶרֶת" },
    torah: [{ label: { en: "Kol HaB'chor", he: "כָּל הַבְּכוֹר" }, range: "Deut. 14:22–16:17" }],
    haftarot: [{ trad: "All", layer: "baraita", inc: "וַיְהִי כְּכַלּוֹת שְׁלֹמֹה לְהִתְפַּלֵּל", en: "Solomon blesses the people", range: "I Kings 8:54–66" }],
    reason: { text: { en: "The haftarah continues Solomon’s dedication, ending on the eighth day when he sent the people home rejoicing.", he: "הַהַפְטָרָה מַמְשִׁיכָה חֲנֻכַּת הַבַּיִת, וּמְסַיֶּמֶת בַּיּוֹם הַשְּׁמִינִי שֶׁשִּׁלַּח אֶת הָעָם." }, src: S.meg31a },
    change: null, flags: [], sources: [S.meg31a, S.ram(12)],
    heb: "וַיְהִי כְּכַלּוֹת שְׁלֹמֹה לְהִתְפַּלֵּל אֶל ה׳ אֵת כָּל הַתְּפִלָּה וְהַתְּחִנָּה הַזֹּאת.", hebSrc: { en: "I Kings 8:54–66; Megillah 31a", he: "מְלָכִים א׳ ח׳:נד–סו; מְגִלָּה ל״א." } },
...
const CHABAD_TEASER = {"Bereishit": "This echoes the Torah portion's recounting of the creation of the world in six days.", "Noach": "The haftorah compares the final Redemption to the pact G‑d made with Noah in this week's Torah reading.", "Lech Lecha": "The haftorah for this week discusses Abraham's journey to the land of Canaan at G‑d's behest, and touches upon Abraham's miraculous battle against the four kings, both of which are described in this week's Torah reading.", "Vayera": "This week's haftorah describes a similar incident that occurred many years later — the prophet Elisha assuring an elderly childless woman that she will bear a child.", "Chayei Sarah": "This week's haftorah describes an aging King David, echoing this week's Torah reading, which mentions that \"Abraham was old, advanced in days.\"", "Toldot": "This follows the theme of this week's Torah reading, whose two protagonists are Jacob and Esau.", "Vayetzei": "This week's haftorah mentions Jacob's flight from home to the \"field of Aram,\" an episode that is recounted in this week's Torah reading.", "Vayishlach": "This week's haftorah mentions the punishment of Edom, the descendents of Esau, whose conflict with Jacob is chronicled in this week's Torah reading.", "Vayeshev": "This week's haftorah contains an allusion to the sale of Joseph by his brothers, an incident discussed in this week's Torah reading.", "Miketz": "This week's haftorah opens with the words \"And Solomon awoke, and behold it was a dream,\" echoing this week's Torah portion which opens with Pharaoh's dreams.", "Vayigash": "This week's haftorah mentions the fusion of the kingdoms of Judah and Joseph during the Messianic Era, echoing the beginning of this week's Torah reading: \"And Judah approached him [Joseph].\"", "Vayechi": "In this week's haftorah, King David delivers his deathbed message to his son and successor, Solomon, echoing this week's Torah reading that discusses at length Jacob's parting words and instructions to his sons.", "Shemot": "This week’s haftorah parallels the week’s Torah reading on many levels.", "Vaera": "This week's haftorah begins with a mention of the ingathering of the exiles, echoing G‑d's promise mentioned in the Torah portion: \"I will take you out of the suffering of Egypt.\"", "Bo": "In the haftorah we read of the punishment G‑d visited upon Egypt centuries later, through the hand of Nebuchadnezzar king of Babylon.", "Beshalach": "This parallels this week's Torah portion which discusses the drowning of the Egyptian forces in the Red Sea and the subsequent songs led by Moses and Miriam.", "Yitro": "This week's haftorah discusses Isaiah’s vision of the Heavenly Chariot (the merkavah), a revelation that was experienced by all the Israelites when G‑d spoke the Ten Commandments on Mount Sinai—an event recounted in this week’s Torah reading.", "Mishpatim": "In this week's haftorah, Jeremiah describes the punishment that would befall the Jews because they continued enslaving their Hebrew slaves after six years of service—transgressing the commandment discussed in the beginning of this week's Torah reading.", "Terumah": "This week's haftorah describes the construction of the Holy Temple under the direction of King Solomon, echoing this week's Torah portion which discusses the construction of the Desert Tabernacle.", "Tetzaveh": "In this week's haftorah, the prophet Ezekiel describes a vision of the altar that will be built for the third Holy Temple and its dedication ceremony—paralleling this week's Torah portion which discusses the dedication of the Tabernacle's altar.", "Ki Tisa": "In this week's haftorah, Elijah the Prophet demonstrates the worthlessness of the Baal, just as Moses chastised the Israelites for serving the Golden Calf, as discussed in this week's Torah reading.", "Vayakhel": "This week's haftorah describes the construction of several components of the Holy Temple by the wise craftsman Hiram of Tyre, paralleling the Torah portion which describes the construction of the Tabernacle by the wise Bezalel and his crew of craftspeople.", "Pekudei": "This week's haftorah describes the dedication of Solomon's Temple, following the theme of this week's Torah reading: the dedication of the desert Tabernacle.", "Vayikra": "Sacrifices are the dominant topic of the week's Torah reading, too.", "Tzav": "This week's haftorah touches on the subject of sacrifices, the main topic of the week's Torah portion.", "Shmini": "This week's haftorah mentions how Uzzah was struck dead when he disrespectfully touched the Ark of the Covenant; reminiscent of Nadab and Abihu's death described in this week's Torah reading.", "Tazria": "This week's haftorah describes how a prophet miraculously cured an Aramite general of his tzara'at ailment.", "Metzora": "This week's haftorah discusses the story of four men stricken by tzara'at, a skin ailment caused by sins — one of the main topics of this week's Torah reading.", "Acharei Mot": "This week's haftorah foretells the exiles and punishments that will befall the Jews because they strayed after the ways of the heathens — behavior that this week's Torah reading proscribes.", "Kedoshim": "This week's haftorah mentions G‑d's repeated enjoinders to observe the commandments, keep the Shabbat and eschew idol worship; reflective of this week's Torah portion, which discusses many commandments, including the obligation to sanctify the Shabbat and reject idolatry.", "Behar": "This week's haftorah discusses the purchase of a field by Jeremiah, echoing one of the themes of this week's Torah portion—the purchase and redemption of real estate.", "Bechukotai": "This follows the theme of this week's Torah reading which details at length the blessings and curses.", "Bamidbar": "An appropriate reading for the first Torah reading of the Book of Numbers.", "Naso": "This week's haftorah describes the birth of Samson, a lifetime nazirite.", "Beha'alotcha": "This haftorah contains a vision of the golden Temple Menorah, whose daily kindling is discussed in the opening of this week's Torah reading.", "Shelach": "This week's haftorah tells the story of the spies that Joshua sent to scout the city of Jericho, prior to the Israelites' invasion of the Holy Land, a point in common with this week's Torah reading, which discusses the twelve spies that were sent by Moses years earlier to explore the Holy Land.", "Korach": "This echoes Moses' statement in this week's Torah reading: \"I have not taken a donkey from a single one of them, and I have not harmed a single one of them.\"", "Chukat": "In his message, he also discussed the Israelites' conquest of the lands of Sichon and Og, victories which are related in this week's Torah reading.", "Balak": "This week's haftorah makes mention of the incident of Balak the king of Moab hiring the sorcerer Balaam to curse the Jewish people — the main topic of this week's Torah reading.", "Pinchas": "According to tradition, Elijah shared the same soul as Pinchas, the hero of this week's Torah portion."};
const MM_HAFT = {"Bereishit": "Isaiah 42:5–43:10 (Seph. 42:5–21)", "Noach": "Isaiah 54:1–55:5 (Seph. 54:1–10)", "Lech Lecha": "Isaiah 40:27–41:16", "Vayera": "II Kings 4:1–37 (Seph. 4:1–23)", "Chayei Sarah": "I Kings 1:1–31", "Toldot": "Malachi 1:1–2:7", "Vayetzei": "Hosea 12:13–14:10 (Seph. 11:7–12:12)", "Vayishlach": "Hosea 11:7–12:12 (Seph. Obadiah 1:1–21)", "Vayeshev": "Amos 2:6–3:8", "Miketz": "I Kings 3:15–4:1", "Vayigash": "Ezekiel 37:15–28", "Vayechi": "I Kings 2:1–12", "Shemot": "Isaiah 27:6–28:13; 29:22–23 (Seph. Jeremiah 1:1–2:3)", "Vaera": "Ezekiel 28:25–29:21", "Bo": "Jeremiah 46:13–28", "Beshalach": "Judges 4:4–5:31 (Seph. 5:1–31)", "Yitro": "Isaiah 6:1–7:6; 9:5–6 (Seph. 6:1–13)", "Mishpatim": "Jeremiah 34:8–22; 33:25–26", "Terumah": "I Kings 5:26–6:13", "Tetzaveh": "Ezekiel 43:10–27", "Ki Tisa": "I Kings 18:1–39 (Seph. 18:20–39)", "Vayakhel": "I Kings 7:40–50 (Seph. 7:13–26)", "Pekudei": "I Kings 7:51–8:21 (Seph. 7:40–50)", "Vayikra": "Isaiah 43:21–44:23", "Tzav": "Jeremiah 7:21–8:3; 9:22–23", "Shmini": "II Samuel 6:1–7:17 (Seph. 6:1–19)", "Tazria": "II Kings 4:42–5:19", "Metzora": "II Kings 7:3–20", "Acharei Mot": "Ezekiel 22:1–16", "Kedoshim": "Amos 9:7–15 (Seph. Ezekiel 20:2–20)", "Emor": "Ezekiel 44:15–31", "Behar": "Jeremiah 32:6–27", "Bechukotai": "Jeremiah 16:19–17:14", "Bamidbar": "Hosea 2:1–22", "Naso": "Judges 13:2–25", "Beha'alotcha": "Zechariah 2:14–4:7", "Shelach": "Joshua 2:1–24", "Korach": "I Samuel 11:14–12:22", "Chukat": "Judges 11:1–33", "Balak": "Micah 5:6–6:8", "Pinchas": "I Kings 18:46–19:21"};
...
function WeeklyRow({ w, lang }) {
  ...
  return (
    <div className="card" style={{ border: `1px solid ${C.line}`, borderRadius: 10, background: C.panel, marginBottom: 8, padding: "12px 14px" }} dir={he ? "rtl" : "ltr"}>
      ...
      {MM_HAFT[w.p] && (
        <div dir="ltr" style={{ marginTop: 6, fontSize: 11.5, color: C.sub }}>
          <a href={MM_URL} target="_blank" rel="noreferrer" style={{ fontWeight: 700, color: C.sub, textDecoration: "none" }}>{tr(lang, T.mmref)}</a>: {MM_HAFT[w.p]}
        </div>
      )}
      {CHABAD_TEASER[w.p] && (
        <div dir="ltr" style={{ marginTop: 6, fontSize: 12.5, color: C.ink, fontStyle: "italic", lineHeight: 1.5, borderLeft: `2px solid ${C.rule}`, paddingLeft: 8 }}>
          {CHABAD_TEASER[w.p]} <span style={{ fontStyle: "normal", color: C.sub, fontSize: 10.5 }}>(Chabad)</span>
        </div>
      )}
      {w.vars && (
