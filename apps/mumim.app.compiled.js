...
const sefariaUrl = ref => {
  ...
  switch (ref.kind) {
    case "tanakh":
      return `${base}${ref.book}.${ref.ch}.${ref.v}`;
    case "mishnah":
      return `${base}Mishnah_${ref.masechet}.${ref.ch}.${ref.m}`;
    case "rambam":
      return ref.h == null ? `${base}Mishneh_Torah,_${ref.work}.${ref.ch}` : `${base}Mishneh_Torah,_${ref.work}.${ref.ch}.${ref.h}`;
    case "rambam_pirush":
      return `${base}Rambam_on_Mishnah_${ref.masechet}.${ref.ch}.${ref.m}`;
    case "shm":
      return `${base}Sefer_HaMitzvot,_${ref.type}_Commandments.${ref.n}`;
    case "sifra":
      return `${base}Sifra,_${ref.parsha},_${ref.unit}_${ref.n}${ref.h ? "." + ref.h : ""}`;
    case "rashi":
      return `${base}Rashi_on_${ref.book}.${ref.ch}.${ref.v}${ref.sub ? "." + ref.sub : ""}`;
    case "gemara":
      return `${base}${ref.masechet}.${ref.daf}`;
    default:
      return null;
  }
};
const formatRefLabel = ref => {
  ...
  switch (ref.kind) {
    case "tanakh":
      return `${ref.book} ${ref.ch}:${ref.v}`;
    case "mishnah":
      return `Mishnah ${ref.masechet} ${ref.ch}:${ref.m}`;
    case "rambam":
      return ref.h == null ? `${ref.work.replace(/_/g, " ")} ch. ${ref.ch}` : `${ref.work.replace(/_/g, " ")} ${ref.ch}:${ref.h}`;
    case "rambam_pirush":
      return `Rambam on Mishnah ${ref.masechet} ${ref.ch}:${ref.m}`;
    case "shm":
      return `SHM ${ref.type === "Negative" ? "LT" : "PC"} ${ref.n}`;
    case "sifra":
      return `Sifra ${ref.parsha} ${ref.unit} ${ref.n}${ref.h ? ":" + ref.h : ""}`;
    case "rashi":
      return `Rashi ${ref.book} ${ref.ch}:${ref.v}${ref.sub ? "." + ref.sub : ""}`;
    case "gemara":
      return `${ref.masechet} ${ref.daf}`;
    default:
...
const MEROACH_ASHECH = {
  ...
  views: [{
    view_id: "tana-kama-mishnah",
    commentator: "Tana Kama (Mishnah Bekhoros 7:5, the unattributed first view)",
    source_ref: {
      kind: "mishnah",
      masechet: "Bekhorot",
      ch: 7,
    ...
    position: "absent_or_single",
    gloss: {
      value: "Meroach ashech refers to a person without testicles, or with only one testicle.",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "(Tana Kama view): The Torah calls a person without Beitzim or with only one Beitzah - 'Mero'ach Ashech'. (paraphrased from dafyomi.co.il review of Bekhoros 44, summarizing the Tana Kama position in the Mishnah at Bekhoros 7:5)",
      sourcing: "snippet",
      claim_type: "text"
    },
    risk_level: "low",
    note: "The Tana Kama is the unattributed first view in the Mishnah at Bekhoros 7:5; the named tanna'im (Yishmael, Akiva, Hanina ben Antigonus) dispute it. AUDIT: Earlier draft of this entry omitted the Tana Kama view entirely, treating the dispute as three-way. Corrected here to four-way. Sourcing labels reflect that this view's text comes from a summary (dafyomi.co.il), not from a verbatim Sefaria primary-source pull."
  }, {
    view_id: "rabbi-yishmael-mishnah",
    commentator: "R' Yishmael (Mishnah Bekhoros 7:5)",
    source_ref: {
      kind: "mishnah",
      masechet: "Bekhorot",
      ch: 7,
    ...
    position: "crushed",
    gloss: {
      value: "A meroach ashech is anyone whose testicles were crushed.",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "R' Yishmael says: A mero'aḥ ashekh is anyone whose testicles were crushed.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Wording sourced from ezrabrand newsletter summary of Bekhoros 44, not from a verbatim Sefaria pull of Mishnah Bekhoros 7:5."
    },
    risk_level: "low"
  }, {
    view_id: "rabbi-yishmael-gemara-reasoning",
    paired_with: "rabbi-yishmael-mishnah",
    commentator: "R' Yishmael's reasoning (Bekhoros 44b)",
    source_ref: {
      kind: "gemara",
      masechet: "Bekhorot",
      daf: "44b"
    ...
    position: "crushed",
    gloss: {
      value: "R' Yishmael declines the Tana Kama view (no testicles / one testicle) because, on that reading, the Torah ought to have written 'chasar ashech' (lacking testicles) rather than 'meroach' (crushed).",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "Rebbi Yishmael ascribes 'Mero'ach Ashech' to someone with crushed Beitzim. He declines to learn like the Tana Kama - because then the Torah ought to have written 'Chasar Ashech'. (dafyomi.co.il review of Bekhoros 44)",
      sourcing: "snippet",
      claim_type: "text"
    },
    risk_level: "low",
    note: "Tied to rabbi-yishmael-mishnah view above. The mishnah states the position; the gemara provides the textual derivation/objection. Reasoning content here is dafyomi-summary-derived (snippet), not from a verbatim Sefaria gemara pull."
  }, {
    view_id: "rabbi-akiva-mishnah",
    commentator: "R' Akiva (Mishnah Bekhoros 7:5)",
    source_ref: {
      kind: "mishnah",
      masechet: "Bekhorot",
      ch: 7,
    ...
    position: "swollen",
    gloss: {
      value: "A meroach ashech is anyone whose testicles are swollen — has wind in his testicles.",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "R' Akiva says: It is anyone that has wind in his testicles, i.e., they are swollen.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Wording sourced from ezrabrand newsletter summary of Bekhoros 44, not from a verbatim Sefaria pull of Mishnah Bekhoros 7:5."
    },
    ...
    view_id: "rabbi-akiva-gemara-reasoning",
    paired_with: "rabbi-akiva-mishnah",
    commentator: "R' Akiva's reasoning (Bekhoros 44b)",
    source_ref: {
      kind: "gemara",
      masechet: "Bekhorot",
      daf: "44b"
    ...
    position: "swollen",
    gloss: {
      value: "R' Akiva derives 'swollen' by reading 'Mero'ach' as 'me-Ru'ach' (from wind/breath). He declines R' Yishmael's reading because, on that, the Torah should have written 'mi-Mero'ach Ashech' rather than 'meroach.'",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "Rebbi Akiva explains it to mean that they are swollen, because the wind got to them (reading 'Mero'ech' as 'me'Ru'ach'). He declines to learn like Rebbi Yishmael - because then the Torah should have written 'mi'Mero'ach Ashech'. (dafyomi.co.il review of Bekhoros 44)",
      sourcing: "snippet",
      claim_type: "text"
    },
    risk_level: "low",
    note: "Reasoning content is dafyomi-summary-derived (snippet), not from a verbatim Sefaria gemara pull."
  }, {
    view_id: "rabbi-hanina-ben-antigonus-mishnah",
    commentator: "R' Ḥanina ben Antigonus (Mishnah Bekhoros 7:5)",
    source_ref: {
      kind: "mishnah",
      masechet: "Bekhorot",
      ch: 7,
    ...
    definition_scope: "lexical",
    position: "non_testicular_dark_appearance",
    gloss: {
      value: "Meroach ashech does not refer to the testicles at all. It refers to a person whose appearance (mar'av) is especially dark (chashukhin). The dafyomi review records this view as referring specifically to a Kushi (a Black person).",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "R' Ḥanina ben Antigonus says: Mero'aḥ ashekh does not refer to the testicles; rather, the reference is to anyone whose appearance [marav] is especially dark [ḥashukhin]. (Bekhoros 44b summary, ezrabrand newsletter); 'Rebbi Chanina ben Antignos, Mero'ach Ashech has nothing to do with the Beitzim, but pertains to a Kushi (a black person).' (dafyomi.co.il review of Bekhoros 44)",
      sourcing: "snippet",
      claim_type: "text"
    },
    risk_level: "low",
    ...
    view_id: "rabbi-hanina-gemara-derivation",
    paired_with: "rabbi-hanina-ben-antigonus-mishnah",
    commentator: "R' Ḥanina's textual derivation (Bekhoros 44b)",
    source_ref: {
      kind: "gemara",
      masechet: "Bekhorot",
      daf: "44b"
    ...
    position: "non_testicular_dark_appearance",
    gloss: {
      value: "R' Ḥanina ben Antigonus derives his reading by switching the 'ches' in 'meroach' — generating an exegetical link to 'chashukhin' (dark) appearance.",
      sourcing: "snippet",
      claim_type: "text",
      note: "The dafyomi summary cuts off mid-explanation: 'extrapolates from the words Mero'ach Ashech, which (by switching the Ches in Mero'ach)...' Full derivation not surfaced in current search; what IS surfaced is the existence of an exegetical move based on letter-swap. Demoted to snippet pending direct gemara text pull."
    },
    risk_level: "medium"
  }, {
    view_id: "rashi-on-21-20-5",
    commentator: "Rashi on Vayikra 21:20:5",
    source_ref: {
      kind: "rashi",
      book: "Leviticus",
      ch: 21,
    ...
    position: "crushed",
    gloss: {
      value: "Per the Targum: 'meris pachadin' — one whose pachadin (testicles) are merussasin (crushed). I.e., one whose testicles are crushed.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "מרוח אשך, according to the Targum, מרס פחדין, which signifies one whose פחדין are מרוססין, i.e., one whose testicles are crushed. פחדין has the same meaning [as testicles].",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from Sefaria search snippet on Rashi_on_Leviticus.21.20.5."
    },
    risk_level: "low",
    note: "Rashi cites Targum Onkelos's Aramaic 'meris pachadin.' Substantively aligns with R' Yishmael's reading (crushed testicles). Rashi himself does not explicitly attribute the position to R' Yishmael; the alignment is a structural inference, not a Rashi statement."
  }, {
    view_id: "rambam-pirush-hamishnayot-7-5",
    commentator: "Rambam Pirush HaMishnayot on Bekhoros 7:5",
    source_ref: {
      kind: "rambam_pirush",
      masechet: "Bekhorot",
      ch: 7,
    ...
    position: "absent_or_single",
    gloss: {
      value: "Rambam in his Pirush (commentary) on Mishnah Bekhoros 7:5 tracks the Tana Kama view: 'one who has no testicles, or who has only one testicle — this is...' (the gloss continues, identifying meroach ashech with the Tana Kama position).",
      sourcing: "snippet",
      claim_type: "text"
    },
    supporting_quote: {
      value: "אין לו ביצים או אין לו אלא ביצה אחת זהו... (Sefaria snippet, Rambam_on_Mishnah_Bekhorot.7.5)",
      sourcing: "direct",
      claim_type: "text"
    },
    risk_level: "medium",
    note: "Sefaria snippet shows Rambam in his Pirush HaMishnayot commenting on the Tana Kama position. The full text is cut off in the search snippet ('זהו...' — 'this is...'); the visible portion confirms that Rambam glosses the Tana Kama view, but does not by itself confirm Rambam's psak-level halachic position. NOTE: Rambam's Pirush HaMishnayot is distinct from his Mishneh Torah; the two can take different positions. Pirush views should not be conflated with psak."
  }, {
    view_id: "rambam-mishneh-torah-bias-hamikdash",
    commentator: "Rambam, Mishneh Torah, Hilchos Bi'as HaMikdash ch. 8",
    source_ref: {
      kind: "rambam",
      work: "Bi'at_HaMikdash",
      ch: 8,
      h: null
    },
    definition_scope: "psak_combined_definition",
    position: "crushed_or_inflated_combined",
    gloss: {
      value: "Rambam rules that meroach ashech includes both one whose testicular membranes were crushed/smeared and one whose testicular membranes are inflated/wind-filled.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "מי שנמרחו אשכיו ... מי שהרוח באשכיו ... הוא מרוח אשך האמור בתורה.",
      sourcing: "direct",
      claim_type: "text",
      note: "Exact Mishneh Torah halacha number still needs final locking; chapter 8 reproductive-organ mumim section."
    },
    risk_level: "medium",
    note: "This is Mishneh Torah psak, not Pirush HaMishnayot. It combines the crushed reading associated with R' Yishmael and the inflated/wind reading associated with R' Akiva."
  }],
  consensus: {
...
const RELEVANT_GAPS = [{
  ...
  description: "Mishneh Torah psak for meroach ashech has been located in Hilchos Bi'as HaMikdash chapter 8, reproductive-organ mumim section. Rambam combines crushed/smeared and inflated/wind-filled testicular conditions. Remaining task: lock the exact standard halacha number for stable Sefaria URL generation.",
  impact: "The consensus block may now rely on Rambam Mishneh Torah for psak-level structure, but the entry remains partial until the exact halacha reference is finalized."
}, {
  gap_id: "rabbi_hanina_kushi_view_sensitivity",
  description: "R' Ḥanina ben Antigonus's view on meroach ashech is recorded in the dafyomi review as 'pertains to a Kushi (a black person).' The underlying Talmudic claim is what the source says; rendering for modern readers requires editorial care. The view is a minority opinion (not adopted in halacha by the alignment of either Rashi or Rambam Pirush) and is being used in the halachic-disqualification context, not as a general statement about race.",
  impact: "JSX UI design must address how this view is rendered. The schema preserves the source faithfully; presentation requires explicit framing about (a) it being minority opinion, (b) the halachic-disqualification context, (c) not silently softening or omitting."
}];
const POSITION_LABELS = {
  absent_or_single: {
    en: "Absent or single testicle",
    he: null,
    gloss: "Tana Kama view: missing or only one testicle"
  },
  crushed: {
    en: "Crushed",
    he: null,
    gloss: "R' Yishmael's view: crushed testicles"
  },
  swollen: {
    en: "Swollen",
    he: null,
    gloss: "R' Akiva's view: swollen with wind"
  },
  non_testicular_dark_appearance: {
    en: "Non-testicular: appearance-based",
    he: null,
    gloss: "R' Ḥanina ben Antigonus's view: dark appearance, not the testicles at all"
  },
  crushed_or_inflated_combined: {
    en: "Crushed or inflated",
    he: null,
    gloss: "Rambam Mishneh Torah: combines crushed/smeared and inflated/wind-filled testicular conditions"
  }
};
...
const CHARUM = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "Anyone whose nose is sunk between his two eyes, so that he is able to paint both his eyes [for cosmetic purposes] with one stroke.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "[Charum] is anyone whose nose is sunk between his two eyes, so that he is able to paint both his eyes [for cosmetic purposes] with one stroke. — This is Rashi's language. (quoted in Ramban on Leviticus 21:18:1)",
      sourcing: "direct",
      claim_type: "text"
    },
    risk_level: "low",
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The word charum means ONLY one who can paint both his eyes with one stroke. (Narrower than the Rabbis' view.)",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "Aba Yosei says: The word charum means only one who can paint both his eyes with one stroke.",
      sourcing: "direct",
      claim_type: "text"
    },
    risk_level: "low",
    ...
    gloss: {
      value: "Even one who cannot paint both his eyes with one stroke (because his nose is not so deeply sunken) may nonetheless come within the term charum.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "But the Rabbis said to him: 'You have overstated it. Even though he cannot paint both his eyes with one stroke' [because his nose is not so deeply sunken, he may nonetheless come within the term charum].",
      sourcing: "direct",
      claim_type: "text"
    },
    risk_level: "low",
    ...
    definition_scope: "expanded_category",
    gloss: {
      value: "Charum encompasses several nose-conditions: sunken nose; obstructed nose; turned-up nose; nose overhanging the lips. The word 'o' (or) in 'o charum o sarua' (21:18) extends the term to all of these.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "Charum is one whose nose is sunk. [How do I know about] one whose nose is obstructed? or one whose nose is turned up? or whose nose overhangs his lips? From the expression o charum, [the word 'o' (or) includes these blemishes].",
      sourcing: "direct",
      claim_type: "text"
    },
    risk_level: "low",
...
const CHARUM_POSITION_LABELS = {
  narrow: {
    en: "Narrow",
    he: null,
    gloss: "Rashi / Aba Yosei: only the deeply-sunken nose enabling cosmetic-paint with one stroke"
  },
  broad: {
    en: "Broad",
    he: null,
    gloss: "Sifra / Rabbis / Ramban: encompasses sunken, obstructed, turned-up, or lip-overhanging noses"
  }
};
...
const SARUA = {
  ...
  views: [{
    ...
    gloss: {
      value: "Rashi on the kohen verse (21:18) glosses sarua as: one of a pair of limbs is mismatched, such as unequal eyes or unequal legs. The kohen is fully disqualified by this condition. Notably, this is a different gloss from how sarua is read in 22:23 (the behemah verse).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Rashi gloss recorded in shulchanaruchharav.com Daily Chumash & Rashi Q&A on Vayikra 21:16-24 ('Q4: שָׂרוּעַ — One of a pair of limbs is mismatched, such as unequal eyes or legs'). Direct Sefaria pull of Rashi on Leviticus 21:18 not yet completed."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "Targum Yonasan reads sarua and kalut in 22:23 as kidney-conditions: sarua = an extra kidney; kalut = a missing kidney. This is a distinct gloss from Rashi's reading of kohen-sarua (mismatched paired limbs). On Targum Yonasan's reading, the same word names different conditions across the two parshiyos.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il D.A.F. Nach section on Vayikra 22:23. Direct Targum Yonasan Aramaic text not pulled in this entry."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "Per Rambam's gloss on Bekhoros 7:2, behemah-sarua denotes an extra limb or an overgrown limb. Distinct from both Rashi's kohen-sarua reading (mismatched paired limbs) and Targum Yonasan's kidney-reading. This is the gloss that maps onto the Mishnah's general discussion of bechor blemishes.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Kollel Iyun Hadaf background outline for Bekhoros 41 records the Rambam-Pirush gloss list. Direct Hebrew text of Rambam Pirush HaMishnayot Bekhoros 7:2 not yet pulled."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "Rashi (citing the Sifra) and Ramban (second reading): the verse permits sarua/kalut as nedavah but disqualifies them as neder. 'Nedavah' here = kodshei bedek habayis (donations for Temple maintenance — kedushas damim, monetary holiness only). 'Neder' here = kodshei mizbeach (offerings on the altar — kedushas haguf). On this reading, the asymmetry is: sarua/kalut may be donated to bedek habayis (where their physical condition does not matter) but cannot be offered on the altar. Rashi's reasoning: the verse adds 'lo yeratzeh' specifically because mizbeach offerings come l'ratzon (to appease).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il D.A.F. Nach section on Vayikra 22:23. Direct Sefaria pulls of Rashi/Ramban texts not completed in this entry. The Sifra citation is the load-bearing source for this reading."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "Ramban (first reading) and Moshav Zekenim: 'neder' is when a person says 'harei alai' (I take upon myself); 'nedavah' is when he says 'harei zeh' (this animal is). Both vow formulas are permitted for bedek habayis but are NOT acceptable on the mizbeach. On this reading, the verse-level asymmetry is narrower: BOTH categories ('neder' and 'nedavah') are excluded from mizbeach; the verse's structure distinguishes the two formulas only to clarify the bedek-habayis permission.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il D.A.F. Nach section on Vayikra 22:23. This reading produces a different picture from Rashi/Ramban#2: on this view, the verse does not permit sarua/kalut for any part of mizbeach service, only for bedek habayis donations. Direct Ramban primary text not pulled in this entry."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      ...
      sourcing: "snippet",
      claim_type: "text",
      note: "This view summarizes the structural finding rather than citing a specific text. The supporting claim — that the lexical AND halachic asymmetries co-occur — is established by the per-source views above."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 21:18 verbatim Hebrew (kohen-sarua)", "Rashi on Vayikra 22:23 verbatim Hebrew (behemah-sarua + nedavah/neder)", "Sifra Emor on 21:18 (sarua) verbatim", "Sifra Emor on 22:23 (sarua + kalut + nedavah/neder) verbatim", "Ramban on Vayikra 22:23 verbatim Hebrew (both readings)", "Targum Yonasan on Vayikra 22:23 verbatim Aramaic", "Mishnah Bekhoros 7:6 (sarua kohen cases) verbatim", "Bekhoros 40a (behemah sarua / kalut) verbatim", "Rambam Mishneh Torah Bias HaMikdash ch. 8 — exact halacha for kohen-sarua", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for behemah-sarua and the nedavah/neder asymmetry"],
  consensus: {
...
const KALUT = {
  ...
  views: [{
    ...
    gloss: {
      value: "Targum Yonasan reads kalut in 22:23 as a missing kidney — paired with his reading of sarua (extra kidney). On this rendering, the verse pairs sarua and kalut as an extra-kidney/missing-kidney duality. This is a distinct lexical reading from the un-split-hooves gloss in the gemara/Rambam-Pirush.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il D.A.F. Nach section on Vayikra 22:23. Direct Targum Yonasan Aramaic text not pulled in this entry."
    },
    ...
    gloss: {
      value: "Kalut shares the verse-level nedavah/neder structure with sarua. Per Rashi/Ramban#2: kalut may be donated to bedek habayis (kodshei damim) but is disqualified from the mizbeach (kodshei haguf). Per Ramban#1/Moshav Zekenim: kalut is excluded from the mizbeach under both vow formulas (harei alai and harei zeh), but permitted for bedek habayis under both. See SARUA for the full machlokes detail.",
      sourcing: "snippet",
      claim_type: "text",
      note: "This view points to the parallel SARUA views rather than restating them — the machlokes is verse-level and applies to both terms together. paired_with reference targets the SARUA entry's Rashi/Ramban#2 view for grouping purposes."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 22:23 verbatim Hebrew (kalut + nedavah/neder)", "Sifra Emor on 22:23 (kalut + sarua) verbatim", "Targum Yonasan on Vayikra 22:23 verbatim Aramaic", "Bekhoros 40a verbatim Hebrew (kalut hooves discussion)", "Rambam Pirush HaMishnayot Bekhoros 7:2 verbatim text", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for kalut", "Mishnah Bekhoros 6:1 verbatim Hebrew (kalut/closed-hoof cases)"],
  consensus: {
...
const IVER = {
  ...
  views: [{
    ...
    gloss: {
      value: "Pierced eyelid, damaged eyelid, chilazon/nachash/eyenav (specific eye conditions), white covering crossing the iris.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Paraphrase of 6:2 verified in Pass-B audit; see MISHNAH.bekhoros_perek_6.mishnayos[1].en. The Mishnah lists eye-blemish cases. Whether these are all subsumed under the Torah term iver requires primary-commentary confirmation. It is enumerating cases, not giving a lexical definition of iver itself."
    },
    risk_level: "medium"
  }],
  ...
  pending_pulls: ["Rashi on Vayikra 21:18 (specifically the iver gloss)", "Bartenura on Bekhoros 6:2 (eye blemishes)", "Bartenura on Bekhoros 7:2-3 (kohen-specific eye conditions)", "Rambam Pirush HaMishnayot on Bekhoros 6:2 and 7:3", "Sifra Emor on iver"]
};
...
const SHAVUR = {
  ...
  views: [{
    ...
    gloss: {
      value: "Sifra on 21:19 addresses the apparent gap between the kohen text 'shever ragel or shever yad' (which on its face restricts to arm/leg) and the animal text 'shavur' (which on its face covers any broken bone). Sifra reads them as denoting the same disqualifying injury — the difference in terminology does not produce a difference in halachic scope. Both kohen and animal are disqualified by the same kind of bone break.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same Sifra material as in SHEVER_RAGEL and SHEVER_YAD entries. Sourced from the Yeshivat Har Etzion (etzion.org.il) SALT Parashat Emor 5782 summary of Torat Kohanim on 21:19. Exact Sefaria primary text and section number not yet pulled."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "lexical",
    gloss: {
      value: "Per Rambam's gloss on Bekhoros 7:2, shavur denotes a broken-limbed animal — straightforwardly, one with a fractured bone. As Rambam himself notes in the same Pirush, definitional disputes between commentators about the precise meaning of these terms do not change the halachic scope, which is established through tradition.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Kollel Iyun Hadaf background outline for Bekhoros 41 records the Rambam-Pirush gloss list explicitly. Direct Hebrew text of Rambam Pirush HaMishnayot Bekhoros 7:2 not yet pulled. The same outline cites Rambam's own meta-claim that definitional disputes don't affect halacha."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "structural",
    gloss: {
      value: "Mishnah Bekhoros 7:1's general rule — that blemishes taught for animals also disqualify a person — applies to shavur via its kohen-side counterparts shever-ragel and shever-yad. The two terminologies converge on the same set of disqualifying broken-bone conditions.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Mishnah text from Sefaria search snippet on Mishnah_Bekhorot.7.1. Direct verbatim Hebrew not pulled in this entry. Same general claim as in GARAV and YALLEFES."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 22:22 (shavur specifically)", "Sifra Emor on 22:22 verbatim Hebrew", "Sifra Emor on 21:19 verbatim Hebrew (shever-shavur equivalence)", "Mishnah Bekhoros 7:1 verbatim Hebrew (Sefaria primary)", "Rambam Pirush HaMishnayot Bekhoros 7:2 verbatim text", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for shavur", "Bekhoros 41a context: shavur's role in the charutz-garav reasoning"],
  consensus: {
...
const CHARUTZ = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "Per Rambam's gloss on Bekhoros 7:2, charutz denotes a gashed condition — including a perforated or split eyelid, nose, or lip, or a gash anywhere there is a bone underneath. The eyelid/nose/lip examples align with Bekhoros 41a's bone-location requirement: each of these has cartilage or bone as its substrate.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Kollel Iyun Hadaf background outline for Bekhoros 41 records this Rambam-Pirush gloss explicitly. Direct Hebrew text of Rambam Pirush HaMishnayot Bekhoros 7:2 not yet pulled. The 'eyelid, nose, lip' examples track the gemara's structural constraint."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "structural",
    gloss: {
      value: "Mishnah Bekhoros 7:1's general rule extends charutz to kohen disqualification as well — but charutz is a behemah-list-only Torah term (not named in 21:18-20). The Mishnah's rule operates by extending the underlying condition (a gash at a bone-location), not by importing the Torah word charutz into the kohen list. For kohanim, similar gash-conditions would fall under different Torah terms (e.g., charum for nose-condition, or under the broader principle).",
      sourcing: "snippet",
      claim_type: "text",
      note: "This view is structural rather than lexical: it documents that charutz-as-a-Torah-word stays in the behemah list, while the underlying physical condition extends to kohanim via the Mishnah's general principle."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 22:22 (charutz specifically)", "Sifra Emor on 22:22 (charutz)", "Mishnah Bekhoros 6:2-3 verbatim Hebrew (eye/nose/lip cases)", "Bekhoros 41a verbatim full Beraisa (Sefaria primary — partial pull complete)", "Rambam Pirush HaMishnayot Bekhoros 7:2 verbatim text", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for charutz"],
  consensus: {
...
const YABELES = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "In the Bekhoros 41a Mishnah/gemara context, the term yabeles is specified as a wart on the eye — not a generic wart anywhere on the body. The discussion treats yabeles alongside chazazis (the broader skin-blister category) but distinguishes the two: yabeles is locus-specific (the eye), while chazazis names the condition itself. The Bekhoros 41a-b sugya treats yabeles as one of the disqualifying conditions on the eye.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Kollel Iyun Hadaf background outline for Bekhoros 41 (line 15: 'yabeles — a wart on the eye'). Direct Hebrew text of the Bekhoros 41a Mishnah/gemara on yabeles not yet pulled from Sefaria. The eye-specific specification is well-attested across the rishonim."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "lexical",
    gloss: {
      value: "Per Rambam's gloss on Bekhoros 7:2, yabeles denotes a wart. In context — the verse pairs yabeles with the boil/skin terms garav and yallefes — the wart in question is specifically of the eye (per the Bekhoros 41a Mishnah context). Rambam's broader meta-claim applies: the precise scope is established through tradition.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Kollel Iyun Hadaf background outline for Bekhoros 41 records the Rambam-Pirush gloss list. Direct Hebrew text not pulled. The Bekhoros 41a context narrows yabeles to the eye."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "structural",
    gloss: {
      value: "Mishnah Bekhoros 7:1's general rule applies to yabeles: an eye-wart that disqualifies an animal also disqualifies a kohen, even though yabeles is not explicitly named in the 21:18-20 kohen list. The disqualification reaches a kohen through the underlying condition (an eye-wart), not through the Torah word yabeles being imported into the kohen-text.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same general claim as in GARAV / YALLEFES / SHAVUR / CHARUTZ. Direct verbatim Mishnah text not pulled in this entry."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 22:22 (yabeles specifically)", "Sifra Emor on 22:22 (yabeles)", "Mishnah Bekhoros 6:12 verbatim Hebrew (yabeles cases)", "Bekhoros 41a verbatim Mishnah text on yabeles", "Rambam Pirush HaMishnayot Bekhoros 7:2 verbatim text", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for yabeles"],
  consensus: {
...
const GIBBEN = {
  ...
  views: [{
    ...
    gloss: {
      value: "Tana Kama states that the kohen-disqualifying blemish 'no eyebrows, or only one eyebrow' is the definition of the term 'gibben' mentioned in the Torah.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Tana Kama-attributed framing recorded in Mishnah Yomit summary of Bekhoros 7:2. Direct Hebrew text of Mishnah Bekhoros 7:2 not yet pulled from Sefaria. The Mishnah's 'no eyebrows or only one eyebrow' formulation is itself the source of the later mefarshim machlokes (see view tiferet-tiferes-bach-machlokes)."
    },
    risk_level: "medium"
  }, {
    ...
    position: "no-eyebrow-hair",
    gloss: {
      value: "Rambam codifies five eyebrow-related blemishes in Bias HaMikdash ch. 8. The first — one who has no hair on his eyebrows — Rambam explicitly identifies as 'the gibben mentioned in the Torah.' Rambam tracks the Tana Kama position from Mishnah Bekhoros 7:2.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "חֲמִשָּׁה בַּגְּבִינִים, וְאֵלּוּ הֵן: (א) מִי שֶׁאֵין לוֹ שֵׂעָר בִּגְבִינָיו. וְזֶה הוּא 'גִּבֵּן' (ויקרא כא, כ) הָאָמוּר בַּתּוֹרָה. (ב) מִי שֶׁגְּבִינָיו שׁוֹכְבִין. (ג) מִי שֶׁאֵין לוֹ אֶלָא גָּבִין אֶחָד. (ד) מִי שֶׁיֵּשׁ לוֹ גְּבִינִין יָתֵר עַל שְׁנַיִם.",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from chabad.org rendering of Rambam Bias HaMikdash ch. 8 (Touger edition with Torat Emet vowelized text). Exact Sefaria halacha number within ch. 8 still to be locked."
    },
    risk_level: "low",
    ...
    gloss: {
      value: "Rashi reads gibben as: one whose eyebrow hair is long and hangs over his eyes. This corresponds to a different case from the Mishnah Bekhoros 7:2 list — not the 'no eyebrow hair' case Rambam identifies as the Torah's gibben, but the 'eyebrows that hang' case (what Rambam codifies as item (b) in his eyebrow list).",
      sourcing: "snippet",
      claim_type: "text",
    ...
    position: "no-eyebrow-hair",
    gloss: {
      value: "Within the Tana Kama / Rambam-MT camp, the later mefarshim disagree on what 'one eyebrow' (the Mishnah's secondary phrasing) means. Tiferet Yisrael: one eyebrow that stretches across both eyes (a single connected unibrow). Tiferet Yaakov: one of the two eyebrows is missing. Bach: the Torah term 'giben' means 'one eye' — and the blemish is therefore one who has hair over only one eye (a sub-camp that re-reads the Torah word itself, lexically distinct from both Rashi and Rambam-MT).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: Mishnah Yomit article 'One Eyebrow' on Bekhoros 7:2. The Bach view is particularly notable — it does not fit the Rashi/Rambam definitional axis. Bach reads 'giben' as etymologically related to 'one eye' (a homonym move), making the blemish a hair-over-one-eye case rather than an eyebrow-hair case at all. Direct Bach text not yet pulled."
    },
    risk_level: "medium",
  ...
  pending_pulls: ["Rashi on Vayikra 21:20 verbatim Hebrew (Sefaria primary)", "Mishnah Bekhoros 7:2 verbatim Hebrew (Sefaria primary)", "Rambam Pirush HaMishnayot Bekhoros 7:5 (or 7:3) full text — meta-framing claim", "Rambam Mishneh Torah Bias HaMikdash ch. 8 — exact halacha number for the gibben psak", "Bekhoros 43b — gemara-level discussion of Mishnah 7:2", "Sifra Emor 3 on gibben", "Bach, Tiferet Yisrael, Tiferet Yaakov primary texts on Mishnah Bekhoros 7:2"],
  consensus: {
...
const DAQ = {
  ...
  views: [{
    ...
    definition_scope: "example_cases",
    gloss: {
      value: "Mishnah Bekhoros 7:3 enumerates eye-blemish cases — including a sclera that encroaches on the cornea — as kohen disqualifications. Whether each enumerated case falls specifically under 'daq' or under 'tevallul' or under 'be'einav' is itself a per-case question (see Bekhoros 44a chain).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Mishnah text not pulled directly from Sefaria — primary text rendering blocked by Sefaria's JS-only page shells in this session. Text content is paraphrased from Sefaria search snippets and Bekhoros 44a parallels."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "derashah",
    gloss: {
      value: "The Beraisa explains why the pasuk uses four distinct eye-blemish terms in sequence: each adds cases the prior term wouldn't catch. After 'iver' (eye missing), 'ish' adds chivrer/mayim kevu'im (cataracts and dimness — total blindness). After 'ish', 'daq' adds eye-blemishes where vision is still possible. After 'daq', 'tevallul' adds cases where vision isn't impaired but the eye structure mixes (white into black). After 'tevallul', 'be'einav' adds eye-positioning blemishes where the eye itself isn't blemished. Daq's distinct role: eye-blemishes with preserved vision.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 44, summarizing the Beraisa. Hebrew not pulled directly. Rava's extrapolation: 'we learn any blemish that causes blindness from Ish; from Dok, we learn any blemish that causes one's vision to deteriorate; from Tevalul, any blemish that causes the parts of the eye to mix.'"
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Mishnah Bekhoros 7:3 verbatim Hebrew text (Sefaria primary)", "Bekhoros 44a verbatim Beraisa text (Sefaria primary)", "Rashi on Vayikra 21:20 (daq gloss)", "Sifra Emor on daq", "Rambam Pirush HaMishnayot on Bekhoros 7:3", "Rambam Mishneh Torah Bias HaMikdash ch. 8 (eye-blemish section)"],
  consensus: {
...
const TEVALLUL_BEINO = {
  ...
  views: [{
    ...
    definition_scope: "derashah",
    gloss: {
      value: "After daq (eye-blemishes with preserved vision), the Torah adds 'tevallul' to include cases where vision isn't impaired but the white of the eye mixes into the iris/cornea ('the white mixes with the black'). Rava's extrapolation: from tevallul we learn any blemish that causes the parts of the eye to mix.",
      sourcing: "snippet",
      claim_type: "text",
      note: "dafyomi.co.il review of Bekhoros 44 summarizing the Beraisa. Hebrew text not pulled directly."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "The Torah adds 'be'einav' (in his eye) after 'tevallul' to extend the disqualification to eye-positioning blemishes — including 'shtei einav lema'lah' (one eye higher than the other), squinting, and similar cases — where the eye itself is not structurally blemished but its position is. The Beraisa names a kohen who squints among the cases learned from this word.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same dafyomi.co.il source. Confirms that 'be'einav' is itself doing exegetical work, not just pronominal."
    },
    risk_level: "medium"
  }, {
    ...
    definition_scope: "example_cases",
    gloss: {
      value: "Mishnah Bekhoros 7:3 enumerates eye-blemish cases that disqualify a kohen, including conditions of the eyelid (ris) — pierced, damaged, or split — and cases where one eye is higher than the other. The Mishnah groups these eye-related disqualifications without explicitly tagging which Torah term (iver, daq, tevallul, be'einav) each case derives from; the gemara at 44a-b does that sorting.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Mishnah text and gemara position both via Sefaria search snippets and dafyomi summaries — not direct verbatim pulls in this session."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Mishnah Bekhoros 7:3 verbatim Hebrew (Sefaria primary)", "Bekhoros 44a verbatim Beraisa text including the chain (Sefaria primary)", "Rashi on Vayikra 21:20 (tevallul b'eino gloss)", "Sifra Emor on tevallul", "Rambam Pirush HaMishnayot on Bekhoros 7:3", "Rambam Mishneh Torah Bias HaMikdash ch. 8 (eye-blemish enumeration)"],
  consensus: {
...
const PISSEACH = {
  ...
  pending_pulls: ["Rashi on Vayikra 21:18 (pisseach gloss — verify exact wording)", "Sifra Emor on pisseach", "Mishnah Bekhoros 7:6 (direct Hebrew primary text pull)", "Bekhoros 45a-b (gemara on the leg/foot cases)", "Bartenura on Bekhoros 7:6", "Rambam Pirush HaMishnayot on Bekhoros 7:6", "Rambam Mishneh Torah Bias HaMikdash ch. 8 (pisseach as kohen mum)", "Pisseach in Devarim 15:21 (bechor) — separate primary-source pull required", "Determination of whether kohen-pisseach and bechor-pisseach are identical or diverge"],
...
const SHEVER_RAGEL = {
  ...
  pending_pulls: ["Sifra Emor on 21:19 (direct primary text pull — exact section/halacha number)", "Rashi on Vayikra 21:19", "Mishnah Bekhoros 7:6 + 7:1 (broken-limb material)", "Bekhoros 44b-45a (shever ragel / shever yad gemara)", "Bartenura on Bekhoros 7:1", "Rambam Pirush HaMishnayot on Bekhoros 7:1", "Rambam Mishneh Torah Bias HaMikdash ch. 8 (shever cases for kohen)", "Cross-reference: how shever-ragel/yad relate to the behemah-list 'shavur' (22:22)"]
};
const SHEVER_YAD = {
  id: "shever-yad",
  name_he: "שֶׁבֶר יָד",
  ...
  pending_pulls: ["Sifra Emor on 21:19 (direct primary text pull — exact section/halacha number)", "Rashi on Vayikra 21:19", "Mishnah Bekhoros 7:6 + 7:1 (broken-limb material)", "Bekhoros 44b-45a (shever ragel / shever yad gemara)", "Bartenura on Bekhoros 7:1", "Rambam Pirush HaMishnayot on Bekhoros 7:1", "Rambam Mishneh Torah Bias HaMikdash ch. 8 (shever cases for kohen)", "Cross-reference: how shever-yad relates to the behemah-list 'shavur' (22:22)"]
};
const GARAV = {
  id: "garav",
  name_he: "גָּרָב",
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa cited at Bekhoros 41a identifies the verse's garav (Vayikra 22:22) as cheres — boils that are hard like earthenware. The same Beraisa identifies yallefes as chazazis hamitzris (Egyptian boils, the kind that affected the Egyptians per Shemos 9:10). The two words in 22:22 thus name two distinct skin conditions, not synonymous boils.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "ותניא: גרב זה החרס, ילפת זו חזזית המצרית. ואמר ר\"ל: למה נקרא שמה ילפת — שמלפפת והולכת עד יום המיתה.",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from Sefaria Bekhorot 41a:7. Translation: 'And it is taught: Garav — this is cheres. Yallefes — this is the Egyptian chazazis. And Resh Lakish said: Why is it called yallefes? Because it clings on and progresses until the day of death.'"
    },
    risk_level: "low"
  }, {
    ...
    definition_scope: "structural",
    gloss: {
      value: "The gemara resolves an apparent contradiction between the Torah's garav (a permanent disqualifying blemish) and the Mishnah's garav (which Bekhoros 6:12 treats as a non-disqualifying transient condition) by establishing three distinct conditions all called garav: (1) the verse's garav = dry inside AND outside, called cheres in Devarim 28:27, incurable (this is the Torah's korban-disqualifying garav); (2) the Mishnah's garav = moist inside AND outside, curable, hence not a permanent mum; (3) the Egyptian garav of Devarim 28:27 = dry inside, moist outside, also incurable. Only the verse's garav (type 1) is the kohen-disqualifying / korban-disqualifying mum.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "אלא תלתא הוו: דקרא — יבש בין מבפנים בין מבחוץ; דמתני' — לח מבחוץ ומבפנים; דמצרים — יבש מבפנים ולח מבחוץ, דכתיב 'ויהי שחין פורח אבעבועות באדם'.",
      sourcing: "direct",
      claim_type: "text",
    ...
    definition_scope: "structural",
    gloss: {
      value: "Mishnah Bekhoros 7:1 opens the chapter on kohen-disqualifying blemishes by stating that the blemishes taught with regard to an animal — whether permanent or transient — also disqualify in the case of a person, with additions specific to humans. This establishes a baseline lexical identity between the kohen-list garav (21:20) and the behemah-list garav (22:22): the same word names the same condition. Per-list halachic edges (e.g., does the same kind of garav disqualify a kohen from full avodah but only specific avodos elsewhere?) remain a per-pasuk question.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Mishnah text from Sefaria search snippet on Mishnah_Bekhorot.7.1. Direct verbatim Hebrew text not pulled in this entry. The general principle is well-established; the per-term edges still require commentary confirmation."
    },
    risk_level: "medium"
  }, {
  ...
  pending_pulls: ["Rashi on Vayikra 21:20 (kohen-garav specifically)", "Rashi on Vayikra 22:22 (behemah-garav specifically)", "Sifra Emor on garav (both lists)", "Mishnah Bekhoros 6:12 verbatim Hebrew (Sefaria primary)", "Rambam Mishneh Torah Bias HaMikdash ch. 8 — exact halacha for kohen-garav", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for behemah-garav", "Rambam Pirush HaMishnayot Bekhoros 7:2 verbatim text (the tradition meta-claim)"],
  consensus: {
...
const YALLEFES = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa cited at Bekhoros 41a identifies the verse's yallefes (Vayikra 22:22) as chazazis hamitzris — the type of boils that afflicted the Egyptians during the plague (Shemos 9:10). Per the gemara's own further analysis, this is a boil dry on the inside and moist on the outside, incurable. Distinct from the verse's garav (which is dry on both sides) and from regular non-Egyptian chazazis (which is curable and treated as transient by Mishnah Bekhoros 6:12).",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "ותניא: גרב זה החרס, ילפת זו חזזית המצרית.",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from Sefaria Bekhorot 41a:7. Translation: 'And it is taught: Garav — this is cheres. Yallefes — this is the Egyptian chazazis.' The same Beraisa establishes the identity for both garav and yallefes."
    },
    risk_level: "low"
  }, {
    ...
    definition_scope: "lexical",
    gloss: {
      value: "Resh Lakish provides an etymological gloss for yallefes: the name comes from מלפפת ('clings on'), because the affliction clings on and progresses until the day of death. This locates yallefes's distinguishing feature in its terminal, progressive character — the affliction does not heal and only worsens.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "ואמר ר\"ל: למה נקרא שמה ילפת — שמלפפת והולכת עד יום המיתה.",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from Sefaria Bekhorot 41a:7. Translation: 'And Resh Lakish said: Why is it called yallefes? Because it clings on and progresses until the day of death.'"
    },
    risk_level: "low",
    ...
    definition_scope: "structural",
    gloss: {
      value: "The gemara resolves an apparent contradiction: the Mishnah (Bekhoros 6:12) treats chazazis as a transient (non-disqualifying) skin condition, while the Torah lists yallefes as a permanent disqualifying mum. Resolution: the Torah's yallefes refers to Egyptian chazazis (chazazis hamitzris) — incurable; the Mishnah's chazazis refers to a regular, non-Egyptian variety which is curable and therefore not a permanent mum. The same Hebrew word can name two distinct conditions across these contexts.",
      sourcing: "direct",
      claim_type: "text"
    },
    supporting_quote: {
      value: "בשלמא חזזית אחזזית לא קשיא: כאן בחזזית המצרית, כאן בחזזית דעלמא.",
      sourcing: "direct",
      claim_type: "text",
      note: "Verbatim from Sefaria Bekhorot 41a:7. Translation: 'Granted, the contradiction between chazazis and chazazis is not difficult: here it refers to the Egyptian chazazis, there to the regular chazazis.'"
    },
    risk_level: "low"
  }, {
    ...
    definition_scope: "structural",
    gloss: {
      value: "Mishnah Bekhoros 7:1's general rule — that blemishes taught for animals also disqualify a person — establishes baseline lexical identity between the kohen-list yallefes (21:20) and the behemah-list yallefes (22:22). Same word, same condition, applied to two halachic regimes.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Mishnah text from Sefaria search snippet. Direct verbatim Hebrew not pulled in this entry. Same general claim as for garav; per-term halachic edges remain a per-pasuk question."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Rashi on Vayikra 21:20 (kohen-yallefes specifically)", "Rashi on Vayikra 22:22 (behemah-yallefes specifically)", "Sifra Emor on yallefes (both lists)", "Mishnah Bekhoros 6:12 verbatim Hebrew (Sefaria primary)", "Rambam Mishneh Torah Bias HaMikdash ch. 8 — exact halacha for kohen-yallefes", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha for behemah-yallefes", "Rambam Pirush HaMishnayot Bekhoros 6:12 / 7:2 — relevant gloss"],
  consensus: {
...
const MA_UCH = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa pairs the four terms: 'u'ma'uch v'kasus' = squashed and crushed; 'v'nasuk v'karus' = severed by hand and cut with a knife. The Beraisa specifies the sequence: first cut with a knife (still attached), then severed by hand. Ma'uch in this lexical pairing means squashed (a less severe form of crushing than kasus's full crushing).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39 (Kollel Iyun Hadaf, Eliezer Chrysler). Direct Hebrew text of the Bekhoros 39b Beraisa not yet pulled from Sefaria."
    },
    risk_level: "medium",
    ...
    position: "testicles",
    gloss: {
      value: "R' Yehuda holds that ma'uch, kasus, nasuk, and karus all refer to testicular blemishes. The gemara amends this initial position to 'also testicles' (af be'beitzim) — since blocking gid blemishes (which are externally visible) would be perverse. R' Yehuda's logic: ma'uch ve'kasus (squashed/crushed) appear shriveled from outside; nasuk ve'karus (severed/cut) hang loosely. Both are externally visible enough to count as galuy.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39. The 'af be'beitzim' amendment is itself a gemara move responding to an objection. Original R' Yehuda position was strict 'testicles only'; gemara expands."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "R' Yossi compromises between R' Yehuda and R' Eliezer ben Ya'akov. For ma'uch and kasus: the terms apply to both gid AND testicles (testicular squashing/crushing IS externally visible enough to count as galuy). For nasuk and karus: the terms apply only to the gid (testicular severing/cutting does NOT count as galuy on its own). For ma'uch specifically, R' Yossi includes both organs.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39. The gemara's analysis: all three tana'im agree chesaron mibifenim is not a chesaron; their machlokes is whether the four blemishes' testicular-versions count as galuy (externally visible). R' Yossi splits — squashing/crushing yes, severing/cutting no."
    },
    risk_level: "medium",
  ...
  pending_pulls: ["Bekhoros 39b verbatim Beraisa text (Sefaria primary)", "Mishnah Bekhoros 6:5 (testicle blemishes in behemah)", "Rashi on Vayikra 22:24", "Sifra Emor on 22:24 (ma'uch / kasus / nasuk / karus)", "Rambam Mishneh Torah Issurei Mizbeach ch. 2 — exact halacha numbers for the four-blemish psak", "Rambam Mishneh Torah Issurei Biyah 16:10 — sirus prohibition direct text", "Sefer HaMitzvos LT 361 verbatim", "Determination of how Rambam paskens the R' Yehuda / R' Eliezer ben Ya'akov / R' Yossi anatomical-scope machlokes"],
  consensus: {
...
const KASUS = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa pairs ma'uch with kasus: 'u'ma'uch v'kasus' = squashed and crushed. Kasus denotes a more severe/complete crushing than ma'uch's squashing — they form a graduated lexical pair. The Beraisa pairs nasuk with karus on the other axis (severing).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39. Direct Hebrew text of the Beraisa not yet pulled from Sefaria."
    },
    risk_level: "medium"
  }, {
    ...
    position: "testicles",
    gloss: {
      value: "R' Yehuda's position: kasus refers to crushed testicles (alongside ma'uch's squashed testicles). Both are externally visible enough to count as galuy. The gemara amends his initial 'testicles only' to 'also testicles' (af be'beitzim).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Yehuda position as for ma'uch; see MA_UCH entry for the underlying chesaron-mibifenim/galuy framing."
    },
    risk_level: "medium"
  }, {
    ...
    position: "gid",
    gloss: {
      value: "R' Eliezer ben Ya'akov: kasus refers only to a crushed gid, not to crushed testicles. Testicular crushing remains chesaron mibifenim and does not count as galuy.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Eliezer ben Ya'akov position as for ma'uch; see MA_UCH for the underlying logic."
    },
    risk_level: "medium"
  }, {
    ...
    position: "compromise-both-organs",
    gloss: {
      value: "R' Yossi's compromise: like ma'uch, kasus applies to both gid AND testicles. Crushing is externally visible enough on the testicles to count as galuy. R' Yossi differs from R' Eliezer ben Ya'akov on this point — and differs from his own treatment of nasuk and karus, which he restricts to the gid only.",
      sourcing: "snippet",
      claim_type: "text",
      note: "R' Yossi's split is a per-pair distinction: ma'uch+kasus get both organs; nasuk+karus get gid only. See NASUK and KARUS entries for the contrasting branch."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Bekhoros 39b verbatim Beraisa text (Sefaria primary)", "Mishnah Bekhoros 6:5", "Rashi on Vayikra 22:24", "Sifra Emor on 22:24", "Rambam Mishneh Torah Issurei Mizbeach ch. 2", "Rambam's psak on the R' Yehuda / R' Eliezer ben Ya'akov / R' Yossi machlokes"],
  consensus: {
...
const NASUK = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa pairs nasuk with karus: 'v'nasuk v'karus' = severed by hand and cut with a knife. Nasuk denotes severing-by-hand. The Beraisa specifies the physical sequence: karus first (cut by knife while still attached), then nasuk (final separation by hand). The Torah's word order (nasuk before karus) is opposite the physical sequence.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39. The sequence claim is the gemara's own — that the verse describes the END state (severed) before the means (knife-cut) for textual reasons, not because severing-by-hand precedes cutting-with-knife in time."
    },
    risk_level: "medium"
  }, {
    ...
    position: "testicles",
    gloss: {
      value: "R' Yehuda's position: nasuk refers to severed testicles (alongside karus's knife-cut testicles). Severed testicles hang loosely, which is externally visible enough to count as galuy. Gemara amends to 'also testicles' (af be'beitzim).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Yehuda position as for ma'uch and kasus; see MA_UCH for the underlying chesaron-mibifenim/galuy framing."
    },
    risk_level: "medium"
  }, {
    ...
    position: "gid",
    gloss: {
      value: "R' Eliezer ben Ya'akov: nasuk refers only to a severed gid, not to severed testicles. Testicular hanging-loose can occur without underlying damage and remains chesaron mibifenim.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Eliezer ben Ya'akov position as for ma'uch and kasus; see MA_UCH for the underlying logic."
    },
    risk_level: "medium"
  }, {
    ...
    gloss: {
      value: "R' Yossi's compromise: unlike ma'uch and kasus (which he applies to both organs), nasuk applies only to the gid. Severed testicles do NOT count as galuy on their own — the hanging-loose appearance can occur without underlying damage. R' Yossi here agrees with R' Eliezer ben Ya'akov against R' Yehuda.",
      sourcing: "snippet",
      claim_type: "text",
      note: "R' Yossi splits the four terms: ma'uch+kasus = both organs; nasuk+karus = gid only. The split point matches the Beraisa's lexical pairing — squashing/crushing on one side, severing/cutting on the other."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Bekhoros 39b verbatim Beraisa text (Sefaria primary)", "Mishnah Bekhoros 6:5", "Rashi on Vayikra 22:24 (specifically on nasuk)", "Sifra Emor on 22:24", "Rambam Mishneh Torah Issurei Mizbeach ch. 2", "Rambam's psak on the R' Yehuda / R' Eliezer ben Ya'akov / R' Yossi machlokes — particularly relevant for nasuk where R' Yossi sides with R' Eliezer ben Ya'akov"],
  consensus: {
...
const KARUS = {
  ...
  views: [{
    ...
    definition_scope: "lexical",
    gloss: {
      value: "The Beraisa pairs karus with nasuk: 'v'nasuk v'karus' = severed by hand and cut with a knife. Karus denotes cutting with a knife — the first step in the physical sequence (organ cut by knife while still attached), with nasuk's hand-severing following. The Torah's word order is reversed from the physical sequence, with the END state (nasuk = severed) named before the means (karus = knife-cut).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Source: dafyomi.co.il review of Bekhoros 39. The reversed-order observation is the Beraisa's own structural reading."
    },
    risk_level: "medium"
  }, {
    ...
    position: "testicles",
    gloss: {
      value: "R' Yehuda's position: karus refers to knife-cut testicles (alongside nasuk's hand-severed testicles). Both are externally visible enough to count as galuy. Gemara amends to 'also testicles' (af be'beitzim).",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Yehuda position as for the other three terms; see MA_UCH for the underlying framing."
    },
    risk_level: "medium"
  }, {
    ...
    position: "gid",
    gloss: {
      value: "R' Eliezer ben Ya'akov: karus refers only to a knife-cut gid, not to knife-cut testicles. Testicular knife-cuts that don't fully sever do not produce sufficiently visible blemish to count as galuy.",
      sourcing: "snippet",
      claim_type: "text",
      note: "Same R' Eliezer ben Ya'akov position as for the other three terms; see MA_UCH for the underlying logic."
    },
    risk_level: "medium"
  }, {
    ...
    position: "compromise-gid-only",
    gloss: {
      value: "R' Yossi's compromise: like nasuk (and unlike ma'uch and kasus), karus applies only to the gid. The knife-cut, like the hand-severing, does not produce sufficiently visible testicular blemish to count as galuy. R' Yossi sides with R' Eliezer ben Ya'akov on this point.",
      sourcing: "snippet",
      claim_type: "text",
      note: "R' Yossi groups karus with nasuk in the gid-only branch of his compromise. The split-point between his two pairs (squashing/crushing → both organs; severing/cutting → gid only) matches the Beraisa's own lexical pairing."
    },
    risk_level: "medium"
  }],
  pending_pulls: ["Bekhoros 39b verbatim Beraisa text (Sefaria primary)", "Mishnah Bekhoros 6:5", "Rashi on Vayikra 22:24 (specifically on karus)", "Sifra Emor on 22:24", "Rambam Mishneh Torah Issurei Mizbeach ch. 2", "Rambam's psak on the R' Yehuda / R' Eliezer ben Ya'akov / R' Yossi machlokes"],
  consensus: {
...
const KOHEN_PASUK_ORDER = ["iver", "pisseach", "charum", "sarua", "shever-ragel", "shever-yad", "gibben", "daq", "tevallul-beino", "garav", "yallefes", "meroach-ashech"];
const KORBAN_PASUK_ORDER = ["iver", "shavur", "charutz", "yabeles", "garav", "yallefes", "sarua", "kalut", "ma-uch", "kasus", "nasuk", "karus"];
...
const Badge = ({
  ...
  const scopePalette = {
    ...
    derashah: {
      bg: colors.derashahBg,
      fg: colors.derashah,
      border: colors.derashah,
      text: "derashah"
    },
    expanded_category: {
      bg: "#fff",
  ...
  if (definition_scope) {
    const p = scopePalette[definition_scope] || {
      bg: "#fff",
      fg: colors.inkSoft,
      border: colors.rule,
      text: definition_scope
    };
    items.push(/*#__PURE__*/React.createElement("span", {
      key: "ds",
      style: {
  ...
  if (label) items.push(/*#__PURE__*/React.createElement("span", {
    key: "l",
    style: {
      fontFamily: fonts.mono,
      fontSize: 9.5,
...
}, "⚠ Term Boundary — do not merge"), /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: 14.5,
    lineHeight: 1.55,
    color: colors.ink
...
}, "▸ Where this lives in the sources"), /*#__PURE__*/React.createElement("div", {
  style: {
    borderLeft: `3px solid ${colors.derashah}`,
    backgroundColor: colors.derashahBg,
    padding: "10px 14px",
    marginTop: 6,
    fontFamily: fonts.serif,
    fontSize: 13,
...
const DoNotConfuseWith = ({
  ...
  }, "Do not confuse with"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: 14.5,
      lineHeight: 1.6,
      color: colors.ink
    }
  }, copy.do_not_confuse)), technicalNote && /*#__PURE__*/React.createElement("details", null, /*#__PURE__*/React.createElement("summary", {
    style: {
      cursor: "pointer",
      fontFamily: fonts.mono,
      fontSize: 10.5,
  ...
  }, "▸ Original wording"), /*#__PURE__*/React.createElement("div", {
    style: {
      borderLeft: `4px solid ${colors.danger}`,
      backgroundColor: colors.dangerBg,
      padding: "12px 16px",
...
const ViewBlock = ({
...
}, view.commentator), /*#__PURE__*/React.createElement(Badge, {
  sourcing: view.gloss?.sourcing,
  risk: view.risk_level,
  definition_scope: view.definition_scope
})), withSensitivityFrame && /*#__PURE__*/React.createElement("div", {
  style: {
    fontSize: 13,
    fontStyle: "italic",
    color: colors.warn,
...
}, "A reading not adopted by Rashi or by Rambam in Mishneh Torah. The Talmud's category here is being used in a narrow halachic context — disqualification of a kohen — and not as a general claim about race."), /*#__PURE__*/React.createElement("div", {
  style: {
    fontFamily: fonts.serif,
    fontSize: 15,
    lineHeight: 1.65,
...
}, view.gloss?.value), view.supporting_quote && /*#__PURE__*/React.createElement("details", {
  style: {
    marginBottom: 8
  }
}, /*#__PURE__*/React.createElement("summary", {
...
}, "↳ Supporting quote"), /*#__PURE__*/React.createElement("blockquote", {
  style: {
...
}, view.supporting_quote.value), /*#__PURE__*/React.createElement("div", {
  style: {
    paddingLeft: 18,
    fontSize: 11
  }
}, /*#__PURE__*/React.createElement(Badge, {
  sourcing: view.supporting_quote.sourcing,
  label: "quote"
}))), /*#__PURE__*/React.createElement("div", {
  style: {
    display: "flex",
  ...
  refObj: view.source_ref
}), view.note && /*#__PURE__*/React.createElement("details", {
  style: {
    flexBasis: "100%",
    marginTop: 4
  }
...
const PositionGroup = ({
  ...
  return /*#__PURE__*/React.createElement("section", {
  ...
  }, "Position"), /*#__PURE__*/React.createElement("h3", {
    style: {
      fontFamily: fonts.display,
      fontSize: 26,
      fontWeight: 500,
  ...
  }, label.en), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 13.5,
      color: colors.inkLight,
  ...
  }, label.gloss), isMinorityView && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 10,
      padding: "8px 12px",
      backgroundColor: colors.warnBg,
  ...
  }, "Alignment"), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 13,
      color: colors.ink,
  ...
  }, "Not adopted by Rashi / Rambam Mishneh Torah"))), lexicalViews.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16
    }
  }, /*#__PURE__*/React.createElement("div", {
  ...
  }, "Lexical views (", lexicalViews.length, ")"), lexicalViews.map(v => /*#__PURE__*/React.createElement(ViewBlock, {
    key: v.view_id,
    view: v,
    withSensitivityFrame: isDarkAppearance && v.view_id === "rabbi-hanina-ben-antigonus-mishnah"
  }))), derashahViews.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 24
    }
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.mono,
      fontSize: 10,
      color: colors.derashah,
      letterSpacing: 1,
      textTransform: "uppercase",
      paddingBottom: 4,
      borderBottom: `1px solid ${colors.derashah}`
    }
  }, "Derashah / textual reasoning (", derashahViews.length, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 12,
      color: colors.inkSoft,
  ...
  }, "This is the textual reasoning behind a position, not a definition of the term."), derashahViews.map(v => /*#__PURE__*/React.createElement(ViewBlock, {
    key: v.view_id,
    view: v
  }))));
};
...
}, "— not psak")), /*#__PURE__*/React.createElement(Badge, {
  sourcing: consensus.sourcing,
...
}, consensus.statement), consensus.note && /*#__PURE__*/React.createElement("details", {
  style: {
    marginTop: 8,
    borderTop: `1px dashed ${colors.unresolved}`,
    paddingTop: 10
  }
}, /*#__PURE__*/React.createElement("summary", {
  style: {
...
}, "▸ Notes on this alignment"), /*#__PURE__*/React.createElement("div", {
  style: {
    fontFamily: fonts.serif,
    fontSize: 12.5,
    lineHeight: 1.55,
...
}, "Open Gaps for this Term"), gaps.map(g => /*#__PURE__*/React.createElement("div", {
  key: g.gap_id,
  style: {
    padding: "12px 14px",
    marginBottom: 10,
...
}, g.gap_id), /*#__PURE__*/React.createElement("div", {
  style: {
    fontFamily: fonts.serif,
    fontSize: 13.5,
    lineHeight: 1.55,
...
const TermCard = ({
  ...
  return /*#__PURE__*/React.createElement("article", {
  ...
  }, term.name_he), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.display,
      fontSize: 22,
      fontStyle: "italic",
  ...
  }, term.name_translit)), /*#__PURE__*/React.createElement("div", {
    style: {
      textAlign: "left",
      fontFamily: fonts.mono,
      fontSize: 11,
  ...
  }, /*#__PURE__*/React.createElement("div", null, "research: ", /*#__PURE__*/React.createElement("strong", {
    style: {
      color: colors.ok
    }
  }, term.research_status)), /*#__PURE__*/React.createElement("div", null, "relation: ", term.relation), /*#__PURE__*/React.createElement("div", null, "views: ", term.views ? term.views.length : 0))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      fontFamily: fonts.serif,
      fontSize: 13.5,
  ...
  }, "TORAH SOURCE"), /*#__PURE__*/React.createElement(SourceLink, {
    refObj: term.torah_source && term.torah_source.ref
  }), /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 12,
      marginRight: 12,
  ...
  }, "in lists: ", (term.in_lists || []).join(", ")))), /*#__PURE__*/React.createElement(ReaderOrientation, {
    termId: term.id
  }), /*#__PURE__*/React.createElement(DoNotConfuseWith, {
    termId: term.id,
    technicalNote: term.term_boundary_note
  }), /*#__PURE__*/React.createElement(HowToReadThisCard, {
    mode: "complete"
  }), term.structure_note && /*#__PURE__*/React.createElement(StructureNote, {
    note: term.structure_note
  }), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8
    }
  ...
  }, groupHeading), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 13.5,
      color: colors.inkLight,
  ...
  }, groupSubhead), /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.mono,
      fontSize: 10.5,
      color: colors.inkLight,
  ...
  }, "Order reflects Mishnah listing, not halachic priority."), groups.map(g => {
    ...
    return /*#__PURE__*/React.createElement(PositionGroup, {
      key: g.position,
      position: g.position,
      label: g.label,
  ...
  })), term.consensus && /*#__PURE__*/React.createElement(ConsensusBlock, {
    consensus: term.consensus
  }), !term.consensus && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 32,
      marginBottom: 24,
      padding: "14px 18px",
      border: `1px dashed ${colors.unresolved}`,
      backgroundColor: colors.unresolvedBg,
      fontFamily: fonts.serif,
      fontSize: 14,
      color: colors.inkSoft,
  ...
  }, "No alignment is proposed for this dispute. Both camps stand on their own; no psak is implied here."), relevantGaps.length > 0 && /*#__PURE__*/React.createElement(GapsBlock, {
    gaps: relevantGaps
  }));
};
...
const TermHead = ({
  ...
  const torahSources = Array.isArray(term.torah_source) ? term.torah_source : term.torah_source ? [{
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, statusText || term.research_status)), term.relation && /*#__PURE__*/React.createElement("div", null, "relation: ", term.relation), /*#__PURE__*/React.createElement("div", null, "views: ", term.views ? term.views.length : 0))), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      fontFamily: fonts.serif,
      fontSize: 13.5,
  ...
  }, "TORAH SOURCE"), torahSources.length === 0 && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: fonts.mono,
      fontSize: 11,
      color: colors.inkLight
    }
  }, "(none)"), torahSources.map((src, i) => /*#__PURE__*/React.createElement("span", {
    key: i,
    style: {
      marginRight: 12
    }
    ...
    refObj: src.ref
  }), src.role && /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: fonts.mono,
      fontSize: 10,
      color: colors.inkLight,
  ...
  }, "(", src.role, ")"), i < torahSources.length - 1 && /*#__PURE__*/React.createElement("span", {
    style: {
      marginLeft: 6,
      color: colors.rule
    }
...
const PartialTermCard = ({
  ...
  return /*#__PURE__*/React.createElement("article", {
  ...
  }, /*#__PURE__*/React.createElement(TermHead, {
    term: term,
    statusText: "partial",
  ...
  }, "Not all the rishonim have been brought yet. What follows is what's confirmed so far."), /*#__PURE__*/React.createElement(ReaderOrientation, {
    termId: term.id
  }), /*#__PURE__*/React.createElement(DoNotConfuseWith, {
    termId: term.id,
    technicalNote: term.term_boundary_note
    ...
    mode: "partial"
  }), term.views && term.views.length > 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 8,
      marginBottom: 24
    }
  ...
  }, "What is currently sourced"), /*#__PURE__*/React.createElement("div", {
    style: {
      backgroundColor: "#fff",
      border: `1px solid ${colors.rule}`,
      padding: "8px 22px",
  ...
  }, term.views.map(v => /*#__PURE__*/React.createElement(ViewBlock, {
    key: v.view_id,
    view: v
  })))), term.pending_pulls && term.pending_pulls.length > 0 && /*#__PURE__*/React.createElement("details", {
    style: {
      marginTop: 24,
      marginBottom: 24
    }
  ...
  }, "▸ Sources still to be checked (", term.pending_pulls.length, ")"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 12
    }
  ...
  }, term.pending_pulls.map((p, i) => /*#__PURE__*/React.createElement("li", {
    key: i,
    style: {
      marginBottom: 4
    }
  }, p))))), term.notes && /*#__PURE__*/React.createElement("details", {
    style: {
      marginTop: 16
    }
  }, /*#__PURE__*/React.createElement("summary", {
  ...
  }, "▸ Notes on this term"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 6,
      padding: "12px 16px",
      borderLeft: `3px solid ${colors.inkLight}`,
...
const PendingTermCard = ({
  ...
  }, "This term hasn't been worked through with the rishonim yet. It's listed here so it isn't lost, but no definition is given."), /*#__PURE__*/React.createElement(ReaderOrientation, {
    termId: term.id
  }), /*#__PURE__*/React.createElement(DoNotConfuseWith, {
    termId: term.id,
    technicalNote: term.term_boundary_note
  ...
  }, p))))), term.note && /*#__PURE__*/React.createElement("details", {
    style: {
      marginTop: 16
    }
  }, /*#__PURE__*/React.createElement("summary", {
...
const ContextLabel = ({
  ...
  const text = mode === "kohen" ? "Kohen context" : mode === "korban" ? "Korban context" : mode === "comparison" ? "Comparison" : null;
  if (!text) return null;
  return /*#__PURE__*/React.createElement("div", {
    style: {
      fontFamily: fonts.mono,
...
const renderTermDetail = (termId, mode) => {
  ...
  switch (termId) {
    case "meroach-ashech":
      return /*#__PURE__*/React.createElement(TermCard, {
        term: filtered,
    ...
    case "iver":
      return /*#__PURE__*/React.createElement(PartialTermCard, {
        term: filtered
      });
    case "sarua":
      return /*#__PURE__*/React.createElement(PendingTermCard, {
        term: filtered
      });
    case "kalut":
      return /*#__PURE__*/React.createElement(PendingTermCard, {
...
const rowBadges = (entry, section) => {
  ...
  const badges = [];
  if (section === "kohen") badges.push({
    text: "Kohen",
    tone: "kohen"
  });
  if (section === "korban") badges.push({
    text: "Korban",
    tone: "korban"
  });
  const isShared = entry.contexts.includes("kohen") && entry.contexts.includes("korban");
  if (isShared) badges.push({
    text: "Shared",
    tone: "shared"
  });
...
const IndexRow = ({
  ...
  }, entry.name_he), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: fonts.display,
      fontSize: 17,
      fontStyle: "italic",
  ...
  }, entry.name_translit), /*#__PURE__*/React.createElement("span", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 14,
      color: colors.inkSoft,
  ...
  }, entry.short_gloss), /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center"
    }
  }, badges.map((b, i) => /*#__PURE__*/React.createElement(ContextBadge, {
    key: i,
    text: b.text,
    tone: b.tone
  }))), /*#__PURE__*/React.createElement("span", {
  ...
  }, hasDetail ? "▸ open" : "▸ pending")), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: 16,
      paddingTop: 4
    }
  }, hasDetail ? renderTermDetail(id, mode === "all" ? "all" : section) : /*#__PURE__*/React.createElement("div", {
    style: {
...
const renderPasukSection = ({
  heading,
  ids,
  mode,
  section
}) => {
  const rows = ids.filter(id => TERM_INDEX[id]).map(id => ({
    id,
    entry: TERM_INDEX[id]
  }));
  ...
  }, rows.length, " ", rows.length === 1 ? "term" : "terms")), rows.map(({
    id,
    entry
  }) => /*#__PURE__*/React.createElement(IndexRow, {
    key: `${section}-${id}`,
    id: id,
    entry: entry,
    mode: mode,
...
const IndexList = ({
  ...
  return /*#__PURE__*/React.createElement("div", null, renderPasukSection({
    heading: "Kohen — Vayikra 21:18–20",
    ids: KOHEN_PASUK_ORDER,
    mode,
    section: "kohen"
...
const buildComparisonRows = () => {
  ...
  sharedIds.forEach(id => {
    ...
    rows.push({
      ...
      relationship: e.relationship === "shared term, different din" ? "Shared term, different din" : "Shared term",
      note: e.short_gloss
    });
  });
  ...
  if (ma && partners.length > 0) {
    const partnerLabels = partners.map(pid => TERM_INDEX[pid] && TERM_INDEX[pid].name_translit).filter(Boolean).join(" / ");
    const partnerPasuk = partners.map(pid => TERM_INDEX[pid] && TERM_INDEX[pid].korban_pasuk).find(p => p);
    rows.push({
...
const ComparisonTable = () => {
  ...
  }, "Kohen vs Korban — overview"), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 13,
      color: colors.inkLight,
  ...
  }, "Index-only. Click a term to read the full entry in one of the other modes.")), /*#__PURE__*/React.createElement("table", {
    style: {
      width: "100%",
  ...
  }, "Kohen"), /*#__PURE__*/React.createElement("th", {
    style: {
      textAlign: "left",
      padding: "8px 10px",
      fontFamily: fonts.mono,
  ...
  }, "Korban"), /*#__PURE__*/React.createElement("th", {
    style: {
      textAlign: "left",
      padding: "8px 10px",
      fontFamily: fonts.mono,
  ...
  }, "Relationship"), /*#__PURE__*/React.createElement("th", {
    style: {
      textAlign: "left",
  ...
  }, "Note"))), /*#__PURE__*/React.createElement("tbody", null, rows.map(r => /*#__PURE__*/React.createElement("tr", {
    key: r.key,
    style: {
      borderBottom: `1px solid ${colors.ruleSoft}`,
      verticalAlign: "top"
  ...
  }, r.term_he && /*#__PURE__*/React.createElement("span", {
    lang: "he",
    dir: "rtl",
    style: {
      fontFamily: fonts.hebrew,
  ...
  }, r.term_label)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "10px",
      fontFamily: fonts.mono,
      fontSize: 11.5,
  ...
  }, formatPasukOrDash(r.kohen_pasuk)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "10px",
      fontFamily: fonts.mono,
      fontSize: 11.5,
  ...
  }, formatPasukOrDash(r.korban_pasuk)), /*#__PURE__*/React.createElement("td", {
    style: {
      padding: "10px",
      color: colors.ink
    }
  }, r.relationship), /*#__PURE__*/React.createElement("td", {
    style: {
...
function MumimMVP() {
  ...
  if (mode === "kohen") {
    ...
    visibleRowCount = KOHEN_PASUK_ORDER.filter(id => TERM_INDEX[id]).length + KORBAN_PASUK_ORDER.filter(id => TERM_INDEX[id]).length;
  }
  ...
  }, "Mumim · Kohen and Korban"), /*#__PURE__*/React.createElement("h1", {
    style: {
      fontFamily: fonts.display,
      fontSize: 44,
      fontWeight: 400,
  ...
  }, "Blemishes in Parshas Emor."), /*#__PURE__*/React.createElement("p", {
    style: {
      fontFamily: fonts.serif,
      fontSize: 16,
      lineHeight: 1.6,
  ...
  }, "Every blemish named in the kohen list (Vayikra 21:18–20) and the korban list (22:22–24), in the order they appear in the pesukim. Click any term to expand it. Terms that appear in both lists (", /*#__PURE__*/React.createElement("em", null, "iver"), ", ", /*#__PURE__*/React.createElement("em", null, "sarua"), ", ", /*#__PURE__*/React.createElement("em", null, "garav"), ", ", /*#__PURE__*/React.createElement("em", null, "yallefes"), ") are shown in both sections. Use ", /*#__PURE__*/React.createElement("em", null, "Compare"), " for a side-by-side overview."), /*#__PURE__*/React.createElement(ModeToggle, {
    mode: mode,
    setMode: setMode
  })), /*#__PURE__*/React.createElement(ContextLabel, {
    mode: mode
  }), mode === "comparison" ? /*#__PURE__*/React.createElement(ComparisonTable, null) : /*#__PURE__*/React.createElement(IndexList, {
    mode: mode
  ...
  }, mode === "comparison" ? /*#__PURE__*/React.createElement(React.Fragment, null, "Showing ", visibleRowCount, " comparison rows.") : /*#__PURE__*/React.createElement(React.Fragment, null, "Showing ", visibleRowCount, " ", visibleRowCount === 1 ? "row" : "rows", " ", "across ", allIds.length, " unique terms — ", completeCount, " complete,", " ", partialCount, " partial, ", pendingCount, " pending."), " ", "Quotes labeled ", /*#__PURE__*/React.createElement("em", null, "snippet"), " were taken from secondary summaries (dafyomi.co.il, ezrabrand newsletter) rather than directly from the Sefaria primary text; quotes labeled ", /*#__PURE__*/React.createElement("em", null, "direct"), " were pulled from Sefaria itself.")));
}
