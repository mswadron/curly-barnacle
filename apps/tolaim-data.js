  ...
  categories: [
    {
      ...
      nodes: [
        { id: "copepods",
          ...
          question: "Whether the copepods in reservoir water engage the din at all is the classic modern machlokes. On the lenient side (R' Belsky and others) the reservoir is treated as מֵי בּוֹרוֹת — collected, standing water — in which such creatures are not in the forbidden category. On the stringent side (R' Dovid Feinstein, R' Elyashiv and others; the OU requires filtering) it is not clear the water keeps that status once it runs through the aqueduct system and is drawn to the tap — whether it counts as still מֵי בּוֹרוֹת or as flowing/drawn water is itself part of the question. Two further points are defined questions, not gut calls: how small still counts as נִרְאֶה לָעֵינַיִם — the poskim give it a measure — and whether a given cup holds a מִיעוּט הַמָּצוּי. Left to the poskim.",
          sources: [
      ...
      ] },
    {
      ...
      nodes: [
        { id: "anisakis",
          ...
          biology: "Eggs hatch in seawater; larvae are eaten by copepods; fish eat the copepods. The larvae burrow through the fish's GUT WALL and encyst on the viscera — then migrate into the edible FLESH, especially post-mortem during cold storage (documented at 0–4°C over 1–3 days). Its origin is outside the fish — it enters through the food chain and lodges first in the gut.",
          ...
          exclusivity: null,
          question: "The live machlokes turns on which fact the din follows. R' Belsky and R' Vaye (and, it is reported, earlier poskim) were lenient — the worm completes its growth in the flesh, and at its ingested microscopic stage it was below the threshold of a sheretz; many Eretz-Yisrael poskim signed a kol koreh to be stringent — it demonstrably came from outside/the water. Even where the biological pathway is well documented, there is more than one way to weigh it: the machlokes is largely a question of din — whether the heter follows where the worm is found, in the flesh, or where it originated, outside — more than a dispute about the raw facts.",
          sources: [
        ...
        { id: "myxo",
          ...
          match: "Their halachic interest is one of size: these organisms live and form their cysts at or below the threshold of the eye — the נִרְאֶה לָעֵינַיִם line that also runs through the Anisakis and NYC-water discussions. What the eye cannot resolve is not what the din of sheretz is speaking about.",
          exclusivity: null,
          question: "The operative question is the size threshold itself — how small a creature still counts as נִרְאֶה לָעֵינַיִם. The poskim treat this as a defined measure rather than a subjective impression, a principle that reaches well beyond fish.",
          sources: [
