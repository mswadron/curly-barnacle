...
const CONCEPTS = [
  {
    id: "sundial",
    title: "Sundial",
    sub: "All the day's zmanim, one opinion at a time",
  ...
  },
  {
    id: "chatzos",
    title: "Chatzos HaYom",
    sub: "Midday \u2014 6 proportional hours",
    basis: { ref: "Shulchan Arukh OC 233:1", url: "Shulchan_Arukh,_Orach_Chayim.233.1" },
  ...
  },
  {
    id: "mincha_gedola",
    title: "Mincha Gedola",
    sub: "6\xBD proportional hours \u2014 earliest Mincha",
    ...
    items: [
      ...
      { label: "Baal HaTanya", type: "zmaniyos", eq: "A + 6.5H; A,T at \u03B8 = 1.583\xB0", d: "Measured from netz amiti to shkia amiti (1.583\xB0).", ref: "Shulchan Arukh HaRav OC 233", url: "Shulchan_Arukh_HaRav,_Orach_Chayim.233", calc: (c) => c.prop(c.dR(1.583), c.dS(1.583), 6.5) }
    ]
  },
  {
    id: "mincha_ketana",
    title: "Mincha Ketana",
    sub: "9\xBD proportional hours \u2014 preferred Mincha",
    basis: { ref: "Berakhot 26b; Shulchan Arukh OC 233:1", url: "Shulchan_Arukh,_Orach_Chayim.233.1" },
    ...
    items: [
      ...
      { label: "Baal HaTanya", type: "zmaniyos", eq: "A + 9.5H; A,T at \u03B8 = 1.583\xB0", d: "Measured from netz amiti to shkia amiti (1.583\xB0).", ref: "Shulchan Arukh HaRav OC 233", url: "Shulchan_Arukh_HaRav,_Orach_Chayim.233", calc: (c) => c.prop(c.dR(1.583), c.dS(1.583), 9.5) }
    ]
  },
  {
    id: "plag",
  ...
  {
    id: "shkia",
    title: "Shkias HaChamah",
    sub: "Sunset",
    basis: { ref: "Shabbos 34b; Shulchan Arukh OC 261:2", url: "Shulchan_Arukh,_Orach_Chayim.261.2" },
    note: "These diverge mainly at altitude. At sea level the three nearly coincide; Jerusalem (754 m) opens a gap of a few minutes.",
    items: [
  ...
  },
  {
    ...
    sub: "Nightfall / end of Shabbos",
    basis: { ref: "Shabbos 34b-35a; Shulchan Arukh OC 261:2, 293:2", url: "Shabbat.34b" },
    items: [
      { label: "3.7 deg", type: "degrees", eq: "\u03B8 = 3.7\xB0 (\u2248 S + \xBEM, M=18, Yeru equinox)", d: "Geonim: night is three-quarters of a mil after sunset. At the Yerushalayim equinox that 13.5-minute span is the sun about 3.7\xB0 down.", dq: Q.bhs, ref: "Geonim, 3/4 mil (Shabbos 34b)", url: "Shabbat.34b", calc: (c) => c.dS(3.7) },
      ...
      { label: "13.5 min", type: "fixed", eq: "S + \xBEM, M = 18 \u2192 13.5", d: "Three-quarters of a mil at an 18-minute mil: 0.75 \xD7 18 = 13.5.", dq: Q.bhs, ref: "3/4 mil at 18-min mil. Shabbos 34b; SA OC 261:2", url: "Shulchan_Arukh,_Orach_Chayim.261.2", calc: (c) => c.addMin(c.ss, 13.5) },
      ...
      { label: "50 min", type: "fixed", eq: "S + 50 (fixed, Igros Moshe)", d: "R' Moshe Feinstein's practical nightfall for Shema and motzaei Shabbos in the US.", ref: "Igros Moshe (US practice for KS / motzaei Shabbos)", calc: (c) => c.addMin(c.ss, 50) },
      { label: "72 min (Rabbeinu Tam)", type: "fixed", eq: "S + 4M, M = 18 \u2192 72", d: "Rabbeinu Tam: four mil from sunset to true nightfall, a mil at 18 minutes: 4 \xD7 18 = 72.", dq: Q.rt4mil, ref: "Rabbeinu Tam, 4 mil. Tosafos Shabbos 35a; SA OC 261:2", url: "Shabbat.35a", calc: (c) => c.addMin(c.ss, 72) },
...
const DAYDIAL = /* @__PURE__ */ new Set(["shma", "tfilla", "chatzos", "mincha_gedola", "mincha_ketana", "plag"]);
function fmt(dt, tz) {
...
function DayDial({ ctx, concept, loc }) {
  ...
  return /* @__PURE__ */ React.createElement("aside", { className: "zm-twilight" }, /* @__PURE__ */ React.createElement("div", { className: "zm-twihead" }, NAME[concept], " on the sundial"), /* @__PURE__ */ React.createElement("div", { className: "zm-twisub" }, "Sunrise to sunset, twelve ", /* @__PURE__ */ React.createElement("i", null, "shaos zmaniyos"), " (one is ", hourMin, " min today, Gra). The shaded wedge spans the opinions, numbered by time (earliest = 1)."), /* @__PURE__ */ React.createElement("div", { className: "zm-dialwrap" }, /* @__PURE__ */ React.createElement("svg", { viewBox: `0 0 ${W} ${H}`, className: "zm-dialsvg", role: "img", "aria-label": NAME[concept] + " on the sundial" }, /* @__PURE__ */ React.createElement("line", { x1: a0[0], y1: cy, x2: a1[0], y2: cy, stroke: "var(--line)" }), /* @__PURE__ */ React.createElement("path", { d: wedge, fill: "var(--gold)", opacity: "0.16" }), Array.from({ length: 13 }).map((_, h) => {
    const fr = h / 12, major = h === 0 || h === 6 || h === 12;
    const ip = pt(fr, R), lp = pt(fr, R + 11);
    return /* @__PURE__ */ React.createElement("g", { key: "g" + h }, /* @__PURE__ */ React.createElement("line", { x1: cx, y1: cy, x2: ip[0], y2: ip[1], stroke: "var(--line)", strokeWidth: major ? 1 : 0.5, opacity: major ? 0.5 : 0.2 }), /* @__PURE__ */ React.createElement("text", { x: lp[0], y: lp[1] + 3, className: "zm-dialhrnum", textAnchor: "middle" }, h));
  }), /* @__PURE__ */ React.createElement("path", { d: arc, fill: "none", stroke: "var(--gold)", strokeWidth: "2", opacity: "0.55" }), OPS.map((o) => {
    const p = pt(o.frac, R);
    return /* @__PURE__ */ React.createElement("g", { key: "m" + o.n }, /* @__PURE__ */ React.createElement("circle", { cx: p[0], cy: p[1], r: "6.5", fill: "#0B1A2E", stroke: o.col, strokeWidth: "1.5" }), /* @__PURE__ */ React.createElement("text", { x: p[0], y: p[1] + 2.6, className: "zm-dialbadge", textAnchor: "middle", style: { fontSize: "8px" } }, o.n));
  }), /* @__PURE__ */ React.createElement("text", { x: a0[0], y: cy + 15, className: "zm-dialanchor", textAnchor: "start" }, "\u05E0\u05E5 " + fmt(sr, tz)), /* @__PURE__ */ React.createElement("text", { x: cx, y: pt(0.5, R)[1] - 7, className: "zm-dialanchor", textAnchor: "middle" }, "\u05D7\u05E6\u05D5\u05EA " + fmt(new Date(sr.getTime() + 6 * (dayMs / 12)), tz)), /* @__PURE__ */ React.createElement("text", { x: a1[0], y: cy + 15, className: "zm-dialanchor", textAnchor: "end" }, fmt(ss, tz) + " \u05E9\u05E7\u05D9\u05E2\u05D4"))), /* @__PURE__ */ React.createElement("div", { className: "zm-sheethead" }, NAME[concept], " \u2014 side by side"), /* @__PURE__ */ React.createElement("div", { className: "zm-sheetsub" }, "Earliest first; each numbered marker matches the dial."), /* @__PURE__ */ React.createElement("div", { className: "zm-sheet" }, OPS.map((o) => /* @__PURE__ */ React.createElement("div", { className: "zm-sheetrow", key: "r" + o.n }, /* @__PURE__ */ React.createElement("div", { className: "zm-sheetname" }, /* @__PURE__ */ React.createElement("span", { className: "zm-sheetnum", style: { borderColor: o.col, color: o.col } }, o.n), o.ab), /* @__PURE__ */ React.createElement("div", { className: "zm-sheetbar" }, /* @__PURE__ */ React.createElement("div", { className: "zm-sheettick is-focus", style: { left: `${BX(o.zt.getTime())}%`, background: o.col }, title: o.ab + " \xB7 " + fmt(o.zt, tz) })), /* @__PURE__ */ React.createElement("div", { className: "zm-sheettime" }, fmt(o.zt, tz))))), /* @__PURE__ */ React.createElement("div", { className: "zm-twinote" }, NAME[concept], " sits at hour ", focusH, " of the day; the opinions differ only in which dawn/dusk bounds the day, shifting the clock time a few minutes. Full method details are on the left."));
}
...
function ZmanimMethods() {
  const [locId, setLocId] = useState(() => { try { return localStorage.getItem("zm_locId") || "newyork"; } catch (e) { return "newyork"; } });
  const [custom, setCustom] = useState(() => { try { return JSON.parse(localStorage.getItem("zm_custom") || "null"); } catch (e) { return null; } });
  const [geo, setGeo] = useState(null);
  const [date, setDate] = useState(() => { const d = /* @__PURE__ */ new Date(); return d.getFullYear() + "-" + String(d.getMonth() + 1).padStart(2, "0") + "-" + String(d.getDate()).padStart(2, "0"); });
  const [concept, setConcept] = useState(() => { try { return localStorage.getItem("zm_concept") || "tzeis"; } catch (e) { return "tzeis"; } });
  const [filter, setFilter] = useState(() => { try { return localStorage.getItem("zm_filter") || "all"; } catch (e) { return "all"; } });
  ...
  const [prefShita, setPrefShita] = useState(() => { try { return JSON.parse(localStorage.getItem("zm_prefShita") || "{}"); } catch (e) { return {}; } });
  React.useEffect(() => { try { localStorage.setItem("zm_locId", locId); localStorage.setItem("zm_concept", concept); localStorage.setItem("zm_filter", filter); localStorage.setItem("zm_prefShita", JSON.stringify(prefShita)); if (custom) { localStorage.setItem("zm_custom", JSON.stringify(custom)); } else { localStorage.removeItem("zm_custom"); } window.dispatchEvent(new CustomEvent("zm-prefs-changed")); } catch (e) {} }, [locId, concept, filter, custom, prefShita]);
  React.useEffect(() => { const onCloud = () => { try { var li = localStorage.getItem("zm_locId"); if (li) setLocId(li); var cu = localStorage.getItem("zm_custom"); setCustom(cu ? JSON.parse(cu) : null); var co = localStorage.getItem("zm_concept"); if (co) setConcept(co); var fi = localStorage.getItem("zm_filter"); if (fi) setFilter(fi); var ps = localStorage.getItem("zm_prefShita"); if (ps) setPrefShita(JSON.parse(ps)); } catch (e) {} }; window.addEventListener("zm-cloud-prefs", onCloud); return () => window.removeEventListener("zm-cloud-prefs", onCloud); }, []);
  const moon = useMemo(() => {
    if (!loc) return null;
  ...
  const dropped = useMemo(() => {
    if (!ctx) return [];
    return con.items.filter((it) => { const dt = it.calc(ctx); return !(dt && !isNaN(dt)); });
  }, [ctx, con]);
  ...
  const useMyLocation = () => {
    if (!navigator.geolocation) {
      setGeo({ ok: false, text: "This browser does not support location lookup." });
      return;
    }
    if (!window.isSecureContext) {
      setGeo({ ok: false, text: "Location needs a secure (https) connection to work." });
      return;
    }
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "zm-root" }, /* @__PURE__ */ React.createElement("style", null, CSS), /* @__PURE__ */ React.createElement("header", { className: "zm-head" }, /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "zm-eyebrow" }, "\u05D6\u05B0\u05DE\u05B7\u05E0\u05B4\u05BC\u05D9\u05DD \xB7 one zman, every method"), /* @__PURE__ */ React.createElement("h1", { className: "zm-title" }, "Where the Opinions Diverge"), /* @__PURE__ */ React.createElement("p", { className: "zm-sub" }, "Same moment in halacha, computed three ways: by degrees below the horizon, by fixed clock minutes, or by zmaniyos (proportional) hours. Pick a zman and watch them spread. Tap a source to open it.")), /* @__PURE__ */ React.createElement("div", { className: "zm-controls" }, /* @__PURE__ */ React.createElement("label", { className: "zm-field" }, /* @__PURE__ */ React.createElement("span", null, "Place"), /* @__PURE__ */ React.createElement("select", { value: custom ? "custom" : locId, onChange: (e) => {
    ...
    return /* @__PURE__ */ React.createElement("div", { key: i, id: `zmrow-${i}`, className: `zm-row ${open ? "is-open" : ""} ${prefShita[concept] === r.label ? "is-default" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "zm-rowtop", onClick: () => setOpenRow(open ? null : key) }, /* @__PURE__ */ React.createElement("span", { className: "zm-rownum" }, i + 1), /* @__PURE__ */ React.createElement("span", { className: "zm-rowtime" }, fmt(r.dt, loc.tz)), /* @__PURE__ */ React.createElement("span", { className: "zm-rowlabel" }, r.label), /* @__PURE__ */ React.createElement("span", { className: "zm-tag", style: { color: TYPES[r.type].color, borderColor: TYPES[r.type].color } }, TYPES[r.type].label), /* @__PURE__ */ React.createElement("span", { className: "zm-rowstar" + (prefShita[concept] === r.label ? " is-def" : ""), title: prefShita[concept] === r.label ? "Your default shita" : "Set as your default", onClick: (e) => { e.stopPropagation(); setPrefShita(function (p) { var n = Object.assign({}, p); if (n[concept] === r.label) { delete n[concept]; } else { n[concept] = r.label; } return n; }); } }, prefShita[concept] === r.label ? "★" : "☆"), /* @__PURE__ */ React.createElement("span", { className: "zm-rowchev" }, open ? "\u2212" : "+")), open && /* @__PURE__ */ React.createElement("div", { className: "zm-rowdetail" }, r.eq && /* @__PURE__ */ React.createElement("div", { className: "zm-roweq" }, /* @__PURE__ */ React.createElement("span", { className: "zm-roweqlab" }, "eq"), r.eq), r.d && /* @__PURE__ */ React.createElement("div", { className: "zm-derivtext" }, r.d), r.dq && /* @__PURE__ */ React.createElement("blockquote", { className: "zm-derivhe", dir: "rtl", lang: "he" }, r.dq), /* @__PURE__ */ React.createElement("div", { className: "zm-derivsrc" }, /* @__PURE__ */ React.createElement(SourceLink, { refText: r.ref, url: r.url }))));
  }), !rows.length && /* @__PURE__ */ React.createElement("div", { className: "zm-empty" }, "No methods of this type for this zman."), dropped.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "zm-note" }, dropped.length + (dropped.length > 1 ? " shitos are" : " shita is") + " not shown: at this latitude and date the sun never reaches the depression they require — " + dropped.map((d) => d.label).join(", ") + "."))), DAYDIAL.has(concept) ? /* @__PURE__ */ React.createElement(DayDial, { ctx, concept, loc }) : /* @__PURE__ */ React.createElement("aside", { className: "zm-twilight" }, /* @__PURE__ */ React.createElement("div", { className: "zm-twihead" }, MORNING.has(concept) ? "Dawn" : "Dusk", " twilight"), /* @__PURE__ */ React.createElement("div", { className: "zm-twisub" }, "Scientific stages by the sun's depression below the horizon", MORNING.has(concept) ? " as it rises" : " as it sets", "."), /* @__PURE__ */ React.createElement("div", { className: "zm-rulercap" }, MORNING.has(concept) ? "Minutes before sunrise" : "Minutes after sunset", ", precise for this date and place"), /* @__PURE__ */ React.createElement("div", { className: "zm-twichart" }, /* @__PURE__ */ React.createElement("div", { className: "zm-minaxis", style: { height: `${twiLayout.total}px` } }, minuteTicks.map((mt, k) => /* @__PURE__ */ React.createElement("div", { key: k, className: `zm-mintick ${mt.major ? "is-major" : ""}`, style: { top: `${mt.y}px` } }, mt.major && /* @__PURE__ */ React.createElement("span", { className: "zm-minlabel" }, mt.m)))), /* @__PURE__ */ React.createElement("div", { className: "zm-twiband", style: { height: `${twiLayout.total}px` } }, twiLayout.bands.map((b, bi) => {
...
.zm-rowstar{flex:none;cursor:pointer;font-size:15px;line-height:1;color:var(--muted);padding:0 2px;transition:color .12s ease;-webkit-tap-highlight-color:transparent;}
.zm-rowstar:hover{color:var(--gold);}
.zm-rowstar.is-def{color:var(--gold);}
.zm-row.is-default{border-color:rgba(233,185,73,.45);background:rgba(233,185,73,.07);}
.zm-row.is-default .zm-rownum{background:var(--gold);color:#1a1206;border-color:var(--gold);}
