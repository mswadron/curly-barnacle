...
function ZmanimMethods() {
  ...
  }), !rows.length && /* @__PURE__ */ React.createElement("div", { className: "zm-empty" }, "No methods of this type for this zman."))), DAYDIAL.has(concept) ? /* @__PURE__ */ React.createElement(DayDial, { ctx, concept, loc }) : /* @__PURE__ */ React.createElement("aside", { className: "zm-twilight" }, /* @__PURE__ */ React.createElement("div", { className: "zm-twihead" }, MORNING.has(concept) ? "Dawn" : "Dusk", " twilight"), /* @__PURE__ */ React.createElement("div", { className: "zm-twisub" }, "Scientific stages by the sun's depression below the horizon", MORNING.has(concept) ? " as it rises" : " as it sets", "."), /* @__PURE__ */ React.createElement("div", { className: "zm-rulercap" }, MORNING.has(concept) ? "Minutes before sunrise" : "Minutes after sunset", ", precise for this date and place"), /* @__PURE__ */ React.createElement("div", { className: "zm-twichart" }, /* @__PURE__ */ React.createElement("div", { className: "zm-minaxis", style: { height: `${twiLayout.total}px` } }, minuteTicks.map((mt, k) => /* @__PURE__ */ React.createElement("div", { key: k, className: `zm-mintick ${mt.major ? "is-major" : ""}`, style: { top: `${mt.y}px` } }, mt.major && /* @__PURE__ */ React.createElement("span", { className: "zm-minlabel" }, mt.m)))), /* @__PURE__ */ React.createElement("div", { className: "zm-twiband", style: { height: `${twiLayout.total}px` } }, twiLayout.bands.map((b, bi) => {
